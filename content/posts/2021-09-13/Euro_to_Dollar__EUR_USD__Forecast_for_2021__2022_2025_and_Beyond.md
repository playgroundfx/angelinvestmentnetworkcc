...
The current rate of the EUR/USD pair is $1.18098. Below, you can see an
...
## Euro/dollar weekly price forecast as of ****13.09.2021

Last week, the EURUSD buyers failed to consolidate the price above the
key resistance zone of the medium-term downtrend 1.1905 – 1.1840. The
trading week closed below level 1.1840, which means a possible price
consolidation under the resistance. One could sell the euro-dollar
according to the pattern with a target in the zone of 1.1733 — 1.1715.

As for the price growth. There could be two scenarios to buy, according
to the methodology:

  1. The price breaks out level 1.1905 and goes up towards Target Zone 2, 1.2033 – 1.2016. If so, the trend will reverse up.
  2. The price stops in the zone of 1.1733 – 1.1715 and draws a reversal pattern. If so, the buyers will again try to turn the trend up via the breakout of the zone of 1.1905 - 1.1840 upside.

### [EURUSD][1] Trading ideas for the week:

  1. Sell according to the pattern in the zone of 1.1905 - 1.1840. TakeProfit: 1.1733. StopLoss: according to the pattern rules.
  2. Buy according to the pattern in the zone of 1.1733 - 1.1715. TakeProfit: 1.1905. StopLoss: according to the pattern rules.
