...
The current price of gold is $1 793.59.
...
## Gold weekly price forecast as of 13.09.2021

The gold buyers failed to consolidate the price above level 1832, which
resulted in sell-offs and a correction down to Target Zone 1784 – 1775.
Target Zone is strong support, where one could look for buy entries with
a target at 1832.

If the gold price goes down below Target Zone, the price should reach
the trend key support 1743 – 1734. In this case, aggressive traders
could enter a short position.

After reaching the trend key support, all short trades should be closed,
as the medium-term uptrend could continue.

[][16]

### [XAUUSD][11] Trading ideas for the week:

  1.  **Aggressively** : sell below 1775. TakeProfit: Target Zone 1743 - 1734. StopLoss: 1790.
  2. Buy according to the pattern in 1743 - 1734. TakeProfit: 1832. StopLoss: according to the pattern rules.
