...
## Weekly Elliott wave ZCash analysis as of 13.09.2021

The ZECUSD market is forming the corrective down wave (B) as a double
zigzag W-X-Y. The first two legs have finished within the zigzag, and
there is unfolding the final sub-wave [Y] as a double zigzag
[W]-[X]-[Y], as outlined in the chart. Let us explore the structure of
the first down sub-wave [W] in the H8 timeframe.
...
completed as a five-wave impulse. The (B) correction is a three-wave
zigzag. There is forming the beginning of the bearish wave (C), which
should be an impulse. The potential impulse wave (C) could drive the
price to a level below 82.71, marked by the (A) wave.

### Weekly [ZECUSD][8] trading plan:

Sell 129.15, TP 82.71
