...
## Weekly Elliott wave Ripple analysis as of 13.09.2021
...
At the time of writing, there have completed two sub-waves (W) and (X)
of the bearish zigzag. Each sub-wave is a simple zigzag. Therefore,
there is developing the initial part of the new descending wave of the
double zigzag. The Ripple price should go down to a level of 0.687,
where a short correction [4] completed. One could enter short trades in
...
The Ripple price today on 14.09.2021 is $1.06840. Looking at the full
