...
Bitcoin price today (27.07.2021) is $37 668.30.
...
## Weekly Elliott wave Bitcoin analysis as of 26.07.2021

As it is clear from the [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) BTCUSD chart, the upward wave (A)
completed as a five-wave impulse. The (A) wave is an element of the
global bullish zigzag. The Bitcoin price is likely to be declining in
the corrective wave that looks like a simple zigzag. Let us study the
most recent chart section in more detail in the eight-hour timeframe.

After the upward impulse (A) completed, the market has turned down and
started forming a new zigzag-shaped pattern. The first sub-wave [A]
could have completed, and the market is now forming the corrective
upwave [B] as a double zigzag (W)-(X)-(Y). The sub-waves (W) and (X)
have completed, and the market should rising in sub-wave (Y) over the
next few days. The price should go up to a level of 42360.00, where wave
[B] will be 38.2% of wave [A]. This ratio is highly likely to be
reached.

### Weekly [BTCUSD][1] trading plan:

Buy 34477.35, TP 42360.00
...
If the current price is at $37 668.30, what is the Bitcoin future value?
...
the current Bitcoin price is at $37 668.30. Usually, it’s a better idea
