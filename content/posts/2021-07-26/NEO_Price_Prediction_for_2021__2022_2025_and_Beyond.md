...
January 2021. The NEO/USD today’s rate is: $33.26
...
## Weekly Elliott wave NEO analysis as of 26.07.2021

In the long term, the NEOUSD is forming the linking wave (X), which is
an element of a larger zigzag. The (X) wave should be unfolding as a
double zigzag W-X-Y. The sub-waves W and X have finished. There is
forming the beginning of the motive down wave Y, which is likely to be a
double zigzag [W]-[X]-[Y]. Let us analyze the initial part of the bear
wave [W] in a shorter timeframe.

Wave [W], based on its first leg, should be a simple zigzag (A)-(B)-(C).
The bearish impulse wave (A), composed of sub-waves 1-2-3-4-5, is likely
to have completed. Therefore, the price should be rising in the bullish
correction (B), as outlined in the chart. The market could go up as high
as level 53.00. At this level, wave (B) will retrace the (A) impulse by
23.6%. One could buy the NEO cryptocurrency in the current situation.
