...
## Weekly Elliott wave EOS analysis as of 26.07.2021

The EOSUSD market continues forming the linking wave (X). It is an
element of a large double zigzag (W)-(X)-(Y). Wave (X) is also unfolding
as a double zigzag W-X-Y. The first two sub-waves look complete. There
is developing the final motive wave Y as a double zigzag [W]-[X]-[Y], as
outlined in the chart. Let us explore the most recent chart section in
the H8 timeframe.

The likely wave [W] could be a simple zigzag (A)-(B)-(C). The (A)
impulse looks complete. There is forming corrective wave (B). There have
finished the first two sub-waves of the (B) wave, the leading diagonal A
and correction B. The market should be rising in the C impulse to a
level of 5.77, where the entire (B) wave will be 23.6% of wave (A). One
