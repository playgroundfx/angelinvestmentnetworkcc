...
January 2021. The NEO/USD today’s rate is: $85.87
...
## Weekly Elliott wave NEO analysis as of 17.05.2021

The NEOUSD market continues forming the upward zigzag A-B-C. The bullish
impulse wave A and the triple zigzag B have completed. The impulse wave
C has just started unfolding. At the moment, only the first two parts of
it have been formed — small sub-waves [1] and [2]. Sub-waves (1) and (2)
of a smaller degree, which are parts of impulse [3], have also
completed. Let's consider the situation in the last part of the chart in
more detail in the eight-hour timeframe.

After the completion of the impulse (1) and the horizontal correction
(2) opposite the impulse, two small sub-waves 1 and 2 began developing.
It can also be assumed that by today the market has built two small sub-
waves [1] and [2] of a smaller degree. In the coming trading days, the
market could rise to the level of 140.56, which was marked by wave [1],
and then even higher. In the current situation, it is possible to
consider entering purchases.
