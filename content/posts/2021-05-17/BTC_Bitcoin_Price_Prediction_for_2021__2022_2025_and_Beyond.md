...
Bitcoin price today (18.05.2021) is $44 493.99.
...
## Weekly Elliott wave Bitcoin analysis as of 17.05.2021

The BTCUSD market should be forming a long-term global regular zigzag
(A)-(B)-(C). The [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) chart displays the structure of the five-wave
impulse (A), which seems to have completed. It is clear from the most
recent chart section that the market has started declining, so there
could be developing a new bearish trend. Let us explore the chart
structure in a more detailed shorter timeframe.

The current chart section displays two complete waves 1 and 2. Wave 1
seems to be an impulse, wave 2 looks like a simple zigzag [A]-[B]-[C].
There is unfolding the initial part of the third wave which could be a
bearish impulse [1]-[2]-[3]-[4]-[5]. The price should go down to a low
of 43000.00, marked by correction 4. Next, the market will start rising
in corrective sub-wave [2] towards a level of 55800.00, where wave [2]
will retrace wave [1] by 76.4%.

### Weekly [BTCUSD][1] trading plan:

Sell 47122.00, TP 43000.00
...
If the current price is at $44 493.99, what is the Bitcoin future value?
...
the current Bitcoin price is at $44 493.99. Usually, it’s a better idea
