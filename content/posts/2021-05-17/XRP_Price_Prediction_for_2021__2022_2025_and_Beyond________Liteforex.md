...
## Weekly Elliott wave Ripple analysis as of 17.05.2021

The XRPUSD market should be developing the corrective down wave, which
could complete as a large double zigzag [W]-[X]-[Y]. There has completed
the motive wave [W] as a triple zigzag. The linking wave [X] is still
forming as a double zigzag (W)-(X)-(Y). Let us look at the final motive
wave (Y), currently unfolding.

Wave (Y) should be unfolding as a double zigzag W-X-Y. Wave W is a
simple zigzag, linking wave X is a contracting horizontal triangle
(A)-(B)-(C)-(D)-(E). Wave Y is also a simple zigzag, but it is larger
than wave [Y]. In the Y wave, there is developing its middle part, the
corrective wave [B], as a triangle. The Ripple price should be rising to
a level of 1.632, where wave (D) will retrace wave (C) by 76.4%. One
...
The Ripple price today is $1.51572. Looking at the full price chart
