...
## Weekly Elliott wave ZCash analysis as of 17.05.2021

The ZECUSD cryptocurrency pair is following a global corrective trend. A
simple zigzag A-B-C is forming in the chart. Its first two parts – sub-
waves A and B – have been completed. The price started to grow in spring
2020. We see the structure of the ascending impulse's initial part.
Let’s have a detailed look at the last segment of the chart on the H8
timeframe.

Sub-waves (1)-(2), 1-2, and sub-wave [1] of a smaller degree have been
completed. Most probably, the market is in a descending corrective wave
[2] which may form as a zigzag (A)-(B)-(C). Impulse wave (C) is required
for the zigzag to be complete. Its ending might be located at the level
of 216.00, where the size of wave [2] will equal 76.4% of wave [1].
Short positions could be considered in the current situation.

### Weekly [ZECUSD][8] trading plan:

Sell 262.69, TP 216.00
