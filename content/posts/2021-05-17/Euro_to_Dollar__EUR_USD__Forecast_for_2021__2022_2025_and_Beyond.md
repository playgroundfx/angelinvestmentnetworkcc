...
The current rate of the EUR/USD pair is $1.21512. Below, you can see an
...
## Euro/dollar weekly price forecast as of 17.05.2021

The euro medium-term uptrend continues, the upside target is to break
through the highs of last week. These highs are close to Target Zone 3,
1.2200 — 1.2184. If the price breaks out the Target Zone 3, the next
upside target in the trend will be Target Zone 4, 1.2360 — 1.2344.

Last week, the price was being corrected, but it didn’t test the trend
border 1.2005 — 1.1988. As a result, there emerged support at level
1.2061.

This week, it will be relevant to enter purchases when the price is
being corrected down to level 1.2061. It will be also relevant to buy at
the trend key support 1.2005 — 1.1988. The target is Target Zone 3.

### [EURUSD][1] Trading ideas for the week:

  1. Buy according to the pattern at level 1.2061. TakeProfit: Target Zone 3, 1.2200 — 1.2184. StopLoss: according to the pattern rules.

  2. Buy according to the pattern in the Target Zone 1.2005 — 1.1988. TakeProfit: Target Zone 3, 1.2200 — 1.2184. StopLoss: according to the pattern rules.
