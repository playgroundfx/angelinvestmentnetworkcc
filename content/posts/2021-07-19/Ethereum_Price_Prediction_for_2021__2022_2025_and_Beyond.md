...
## Weekly Elliott wave Ethereum analysis as of 19.07.2021

The ETHUSD market must have completed the upward zigzag A-B-C, where
sub-waves A and C are impulses, and the B correction is a bearish triple
zigzag [W]-[X]-[Y]-[X]-[Z]. Therefore, there is developing the initial
element of the new bearish trend. The market should be forming a zigzag
A-B-C. Let us look at the most recent chart section in the eight-hour
timeframe.

After the bullish impulse wave C finished, the price has started
declining. The descending impulse wave A seems to have completed.
Therefore, there must be unfolding the upward correction B as a simple
zigzag. There should have been completed the [A] impulse and the [B]
correction, so there must be soon forming the upward impulse wave [C].
The [C] wave should end at a level of 2700.00, where wave B will retrace
wave A by 38.2%. This ratio is highly likely to be reached.

### Weekly [ETHUSD][2] trading plan:

Buy 1955.63, TP 2700.00
...
ETH is traded at $1 819.48. Below you can see how the price of ETH
