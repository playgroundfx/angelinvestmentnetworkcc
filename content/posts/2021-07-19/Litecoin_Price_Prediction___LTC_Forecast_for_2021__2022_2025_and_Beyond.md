...
The LTCUSD pair, based on the Elliott wave theory, must have completed
the global simple zigzag, composed of the sub-waves A-B-C. Therefore,
the market should be declining in the next few weeks forming a new
downtrend. There must be developing the inceptive part of the bearish
zigzag [A]-[B]-[C].  Let us study the most recent chart section in more
detail in the eight-hour timeframe.

There must have formed the descending wave [A] as a five-wave impulse.
Next, the market has started rising. There could be forming the bullish
correction [B] as a double zigzag (W)-(X)-(Y), with the first two parts
completed inside. Therefore, the price should be rising in the final
motive sub-wave (Y). The price should go up to a level of 222.00, where
wave [B] will retrace wave [A] by 38.2%.
...
The Litecoin price today is  $113.98. This value is interactive so that
