...
## Weekly Elliott wave ZCash analysis as of 19.07.2021

The ZECUSD market  is forming the corrective wave (B) as a double zigzag
W-X-Y. The first motive wave W is a triple zigzag [W]-[X]-[Y]-[X]-[Z].
The linking wave X is a double zigzag [W]-[X]-[Y]. The second motive
wave Y has just started, and could also end as a double zigzag
[W]-[X]-[Y]. Let us study the structure of the most recent chart section
in more detail in the H8 timeframe.

There should be forming the descending wave [W] as a standard zigzag
(A)-(B)-(C). The impulse wave (A) should finish soon, and the price will
be following the (B) correction up to a level of 152.90. At this level,
the (B) wave will be 23.6% of wave (A). One could enter long trades in
