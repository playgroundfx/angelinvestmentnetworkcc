...
## Weekly Elliott wave Ripple analysis as of 19.07.2021

As it is clear from the [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) XRPUSD timeframe, the global impulse wave
A completed. Next, the price started declining, following the corrective
pattern. There must be forming the double zigzag [W]-[X]-[Y], with the
motive wave [W] and linking wave [X] completed inside. Therefore, there
must be unfolding the final motive wave [Y].  Let us study the most
recent chart section in more detail in the H8 hour timeframe.

Since April 2021, the XRPUSD market has been forming the descending
double zigzag (W)-(X)-(Y). In the second half of July, the first motive
wave (W) completed as a simple zigzag A-B-C. There is forming the
linking wave (X) as a double combination W-X-Y. The market should be
rising in sub-wave Y, as outlined in the chart, to a level of 1.053. At
this level, the (X) wave will be 38.2% of wave (W).
...
The Ripple price today on 20.07.2021 is $0.56019. Looking at the full
...
On January 4th, 2018, the [XRP/USD][8] rate reached an all-time high.
...
The events from April to June 2021 confirmed that the [XRP/USD][9] pair
...
( {{count}} {{title}} )
   ...
   8. www.liteforex.com/trading/trading-instruments/crypto/xrpusd/
   9. my.liteforex.com/%5Ctrading/chart?symbol=XRPUSD
   10. coinpriceforecast.com/ripple-forecast-2020-2025-2030