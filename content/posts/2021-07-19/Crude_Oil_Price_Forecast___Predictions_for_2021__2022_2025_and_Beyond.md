...
## Oil weekly price forecast as of 19.07.2021

The oil traders are trying to break out the support at 70.89 and reverse
the medium-term trend down. If the support is broken out, the downside
target will be the Target Zone 2, 65.79 — 65.26.

However, if the key support is held up, the price should grow. In this
case, one should find a buy pattern and buy oil with a target at the
Target Zone 4, 78.14 — 77.63.
