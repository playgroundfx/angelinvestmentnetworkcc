...
The current rate of the EUR/USD pair is $1.18000. Below, you can see an
...
## Euro/dollar weekly price forecast as of 19.07.2021

The EURUSD continues declining slowly in the medium-term downtrend. The
downside target is Target Zone 3, 1.1738 – 1.1720. The first strong
support zone is 1.1789 – 1.1775. If the support is broken out, it will
be relevant to enter short trades with the above-indicated target.

If the support zone is held up, the price will be corrected up to
1.1775. This is the trend key resistance, according to technical
analysis.

### [EURUSD][1] Trading ideas for the week:

If level 1.1775 is broken out, sell. TakeProfit: Target Zone 3, 1.1738 -
1.1720. StopLoss: above the next local high.
