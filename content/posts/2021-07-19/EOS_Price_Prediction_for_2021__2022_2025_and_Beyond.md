...
## Weekly Elliott wave EOS analysis as of 19.07.2021

The EOSUSD market continues forming the middle leg of the global double
zigzag, the linking wave (X). The (X) wave is unfolding as a double
zigzag, marked with the red letters W-X-Y. The first two sub-waves look
complete. There is developing the final motive wave Y as a double zigzag
[W]-[X]-[Y], as outlined in the chart. Let explore the most recent chart
section in the H8 timeframe.

There is forming the initial part of the bear wave [W], which could be a
simple zigzag (A)-(B)-(C). Impulse wave (A) looks complete. There is
forming correction (B). In the (B) wave, there have completed two sub-
waves, the leading diagonal A and correction B. Therefore, the market
should be rising in the C impulse to a level of 7.50. At this level,
wave (B) will be 38.2% of wave (A).
