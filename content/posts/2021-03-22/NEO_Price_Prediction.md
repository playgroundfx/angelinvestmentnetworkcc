...
## Weekly Elliott wave NEO analysis as of 22.03.2021

The NEOUSD's current structure indicates that an uptrend's first part is
forming in the market. Bullish impulse A appears to have fully
developed, and then its corrective wave B formed as triple zigzag
[W]-[X]-[Y]-[X]-[Z]. Then, the first waves formed as part of impulse C.
Let's examine the ultimate segment of the chart in detail on the H8 time
frame.

The market formed sub-waves [1] and [2], and then the pair continued
rising in impulsive wave (1), consisting of waves 1-2-3-4-5. Next, after
that wave formed, there was a fall in the bearish corrective wave (2).
Wave (2) has not been fully completed yet. It is unfolding as a simple
zigzag А-В-С where A and B are fully formed, and wave C has just started
developing. Thus, the market may fall to 31.00 in bearish impulse C this
trading week, as the chart suggests.
