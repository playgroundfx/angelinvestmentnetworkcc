...
## Weekly Elliott wave Ethereum analysis as of 22.03.2021

The ETHUSD market continues forming the global zigzag A-B-C, with the
first two sub-waves completed inside – impulse wave A and bearish
corrective wave B. Wave B is a large triple zigzag [W]-[X]-[Y]-[X]-[Z].
Since early 2020, the market has been developing the upward impulse wave
C. The C is about to end soon, as its first four parts have finished;
the final, fifth, leg is more than 50% complete. Let us explore the
...
impulse wave (1)-(2)-(3)-(4)-(5). Last month, the market finished the
corrective down wave (4) as a simple zigzag A-B-C. Next, the market
turned up and started rising in the impulse wave (5). The market should
be declining in correction 4 in the near future. Next, the market will
resume growing in the final wave 5 to a level of 2130.00. At this level,
wave (5) will be 50% of the impulse wave (3). One could enter purchases
in the current situation.

### Weekly [ETHUSD][1] trading plan

Buy 1778.11, TP 2130.00
...
ETH is traded at $1 682.46. Below you can see how the price of ETH
