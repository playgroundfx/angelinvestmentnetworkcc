...
## Weekly Elliott wave ZCash analysis as of 22.03.2021

The first part of a new uptrend started forming after a big bullish
impulsive wave A formed and a long corrective wave B developed as triple
zigzag [W]-[X]-[Y]-[X]-[Z]. As the market is just forming a series of
impulse C's first parts, the pair is unlikely to grow much faster in the
next two months. Corrective wave (2) that is forming now should be given
special attention. Let's have a closer look at the chart.

The H8 time frame suggests that the market fully formed sub-waves
[1]-[2]. Then the price soared in impulse (1), just like it was with the
NEOUSD. Then correction (2) started forming. By its structure,
correction (2) consists of sub-waves А-В-С and is developing as a zigzag
where wave B is an ascending zigzag. Wave B appears to have fully
formed, so we see the market declining to 94.00 in bearish impulse C.
Thus, the current situation may suggest short positions.

### Weekly [ZECUSD][8] trading plan:

Sell 150.77, TP 94.00
