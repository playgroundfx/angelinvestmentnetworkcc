...
## Weekly Elliott wave EOS analysis as of 22.03.2021

A downward corrective wave B shaped as a triple zigzag
[W]-[X]-[Y]-[X]-[Z] continues forming in the EOSUSD chart. The
penultimate part of that wave - linking wave [X] - has formed recently,
and the pair then continued falling in the ultimate wave [Z]. Let’s have
a detailed look at its structure.

Wave [Z] is made of sub-waves (W)-(X)-(Y) and is structured as a double
zigzag. Wave (W) is fully completed and contains sub-waves А, В, and С.
Wave (X) is forming at the moment. Wave (X) is a double zigzag and
contains waves W-X-Y. The pair may grow in the ultimate part of wave Y
to around 4.68 in the nearest time. At that level, the size of the
corrective linking wave (Х) will be 61.8% of (W) according to Fibonacci
ratios. The probability of reaching that ratio is quite high.
