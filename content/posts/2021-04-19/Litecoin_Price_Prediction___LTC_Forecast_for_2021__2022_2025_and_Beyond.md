...
## Weekly Elliott wave Litecoin analysis as of 19.04.2021

The LTCUSD market situation is similar to that of the cryptocurrencies
described above. For a long time, the market has been forming a global
standard zigzag composed of the three major sub-waves A-B-C. Waves A and
C are simple impulses, B is a correction in the form of a bearish triple
zigzag. All three waves look complete. Therefore, over the next few
weeks, the price should be declining in the new bearish trend. Let us
see the market structure in more detail in a shorter timeframe.

The eight-hour timeframe displays the structure of the upward impulse
wave C composed of five sub-waves [1]-[2]-[3]-[4]-[5]. After the
triangle corrective wave [4] completed, the price started rising in the
final impulse [5], which is likely to be complete. There should be
unfolding a simple down zigzag [A]-[B]-[C], which is an element of a
larger downward pattern. The impulse wave [A] may have finished, so the
price should be rising in the corrective wave [B] this week to a level
of 310.00. At this level, wave [B] will be 76.4% of the [A] impulse.
Next, the market could go down in the final wave [C] to a level below
192.00, which is a low marked by correction [4].

### Weekly [LTCUSD][2] trading plan:

Buy 264.30, TP 310.00
...
The LTC price today is $269.20. This value is interactive, so you will
