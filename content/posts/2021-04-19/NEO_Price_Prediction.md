...
## Weekly Elliott wave NEO analysis as of 19.04.2021

The NEO/USD pair is forming a long-term upward zigzag A-B-C. Impulse
wave A and the triple zigzag B have completed. Impulse wave C has just
started forming. So far, there have finished its two first sub-waves,
[1] and [2], and two sub-waves (1) and (2) of a smaller degree which are
the elements of impulse [3]. Let us study the market structure in more
detail in the H8 timeframe.

In late March 2021, the market finished the corrective wave (2) as a
double three (W)-(X)-(Y). Next, the price has started rising in impulse
wave 1. Four out of five legs have completed within wave 1. The price
should be rising in wave [5] of 1 to a level of 111.00. At the indicated
level, wave [5] will reach 200% Fibonacci of impulse [3]. Bulls should
be able to drive the price up to this level.
