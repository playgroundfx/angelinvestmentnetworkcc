...
Bitcoin price today (20.04.2021) is $56 120.19.
...
## Weekly Elliott wave Bitcoin analysis as of 19.04.2021

The BTCUSD market is forming a long-term zigzag-shaped trend. In the
[daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) timeframe, there is the second part of the upward impulse wave
(A), which is the first sub-wave of the bullish zigzag. The (A) wave may
have completed, the beginning of the bearish correction is currently
unfolding. There should be developing a double zigzag W-X-Y, with the
first sub-wave W completed inside. Therefore, Bitcoin price should be
rising in the linking wave X. Let us see the most recent chart section
in more detail.

It is clear from the eight-hour chart that a diagonal has concluded a
large impulse wave (A). The market has turned down and is now declining.
As I have already written above, there is likely to be unfolding a
double zigzag. There should be forming the beginning of the linking wave
X. Wave X can well reach 76.4% of wave W, so the market should be rising
up to a level of 61200.00. Upon reaching the indicated level, the price
could start declining in wave Y.

### Weekly[ BTCUSD][1] trading plan:

Buy 55018.50, TP 61200.00
...
If the current price is at $56 120.19, what is the Bitcoin future value?
...
the current Bitcoin price is at $56 120.19. Usually, it’s a better idea
