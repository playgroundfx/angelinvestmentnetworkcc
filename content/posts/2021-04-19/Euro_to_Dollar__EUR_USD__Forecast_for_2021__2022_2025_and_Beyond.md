...
The current rate of the EUR/USD pair is $1.20369. Below, you can see an
...
## Euro/dollar ****weekly price forecast as of 19.04.2021

The EURUSD trend has turned up. Last week, the price consolidated above
Target Zone 1.1880 - 1.1864. The target in the uptrend is Target Zone 2,
1.2040 – 1.2024. The price can reach this resistance right away or
following a correction.

In case of a correction, it will be relevant to buy the euro in the
strong support levels. The strongest support level is the trend border
1.1834 - 1.1818.

If Target Zone 2 is reached without a correction, we shall watch the
reaction of sellers after the level test. The zone will be either broken
out or held up, depending on which, there will be opportunities to
trade.

### [EURUSD][1] Trading ideas for the week:

Buy in the Target Zone 1.1834 - 1.1818. TakeProfit: Target Zone 2,
1.2040 - 1.2024. StopLoss: 1.1778.
