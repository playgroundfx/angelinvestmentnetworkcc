...
The oil price for today is $63.489. The chart below is interactive, so
...
## Oil weekly price forecast as of 19.04.2021

Last week, the gold price was trading according to the alternative
scenario. The price rose to the key resistance of the medium-term
downtrend 62.84 - 62.33. The buyers tried to consolidate above the zone
but didn’t break out level 63.32.

This week, the oil downtrend should go according to one of the below
scenarios:

  1. The price breaks out the Target Zone and consolidates above,
  2. It is not relevant to buy. The recommendation is to enter sell trades. The target will be 57.35.

It is not relevant to buy. The recommendation is to enter sell trades.
The target will be 57.35.

### [USCrude][6] Trading ideas for the week:

  1. Sell in the Target Zone 62.84 - 62.33. TakeProfit: 57.35. StopLoss: StopLoss: according to the pattern rules
