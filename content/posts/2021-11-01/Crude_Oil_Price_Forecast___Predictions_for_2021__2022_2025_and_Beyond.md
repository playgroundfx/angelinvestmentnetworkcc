...
I always do a technical analysis of at least three time frames to make a
realistic oil forecast. First, we'll analyze the [US Crude][3]'s price
movements on the monthly chart.

The chart above provides the [WTI oil market][4]'s 2013 – 2021 price
[history](https://www.fixpro.org/post/chargeless-historical-data-api-backtesting/).

A strong resistance level of 73.80 USD was formed in June 2018. The US
Crude value has come close to that level, but the buyer has failed to
settle above it so far. If sellers win, the nearest support level will
be at around 26.20 USD.

 On the whole, the chart points to a descending potential of the US
Crude price.

Now let's switch to [Fibonacci ratios][5]. The [US Crude][4]'s price
chart above displays five areas outlined for a bearish trend according
to Fibo ratios. Each of the areas features a specific price pattern:
...
A trend may have numerous consolidation and trend development areas, but
only one area 1 and 5.

### WTI Crude Forecast For Next Three Months

The price is in the first area, testing the trend's limit. A breakout
will point to a possible change in the oil market's trend, and the whole
bearish formation may be canceled.

The resistance level of 73.80 USD mentioned above hinders the further
growth of WTI oil as well. The price looks stuck within the limits of
the first area, and a breakout to the upside looks hardly possible.

The price will most likely consolidate in a narrow range of 65 - 74 USD
and then move into a downward range of area 2. It will be held up there
until the end of the year at least.

The [MACD][6] confirms the bearish correction too. The chart above shows
a cascade of the histogram's divergences with the price chart. At the
same time, the MACD's moving averages show a bearish crossover for the
second time and are directed down.

That's a clear bearish signal for a weekly TF chart. So, based on the
Fibonacci ratios, we can presume the bearish potential of oil is at
around 50 US dollars.

### Long-Term US Crude Analysis for 2021/2022

The analysis of oil price [history](https://www.fixpro.org/post/chargeless-historical-data-api-backtesting/) over the past years shows a strong
support area in the range of 42.10 - 34.25 USD. A more realistic
forecast suggests a price move to consolidation area 3 in the long term.
A future oil price might then reach the buyer's blue area marked in the
chart.

Will the oil price's projected fall stop afterward? It's hard to say for
now as everything will depend on the buyer's reaction to the level of 35
USD. If bulls fail to resist a bearish attack, the price may sink to the
[historical](https://www.fintechee.com/services/historical-data-for-forex/) low of 34.1 USD. It’s towards the end of the next year that
we’ll understand whether or not such a fall is possible.

To calculate the [US Crude][4] (WTI) expected trading range, I used [Bollinger bands][7].
...
Let’s finalize our technical analysis of [US CRUDE][4].

The key levels are marked in the chart above. Short positions appear to
be quite relevant as the projected oil price may drop to 35 USD within
one or two years.

They can be opened at the current level at around 67 USD. Stop Loss
should be placed above the latest high of 77 USD.

Profits can be fixed at two targets: a shorter-term target is at around
49 USD. More patient bears might be lucky to close at approximately 35
USD.

You can also close 50% of your position at the first target and then fix
the rest at 35 USD. Observing your risk management rules is very
important. Avoid losses exceeding 1% of your deposit!
...
Our blog provides [[daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) short-term oil forecasts][9] and trading
signals based on technical analyses and margin zones.

[USCrude][10] Technical analysis is presented by [Mikhail Hypov][11].

## Oil weekly price forecast as of 01.11.2021

Last week, The oil price corrected down in the medium-term uptrend.
Following the correction, the price tested the support level of 81.21
but didn’t break it out. The price has been up again and is trying to
break out the resistance, Target Zone 4, 83.45 — 82.92.

The medium-term trend remains up. If the price breaks out TZ4 and
consolidates above, the next upside target will be Target Zone 5, 88.75
– 88.22.

If the support level 81.21 is broken out, the price will test the trend
key support 79.86 - 79.35. I recommend entering new purchases either in
the trend key support zone or after the price breaks out Target Zone 4
on the retest.

### [USCrude][12] Trading ideas for the week:

  1. Aggressively: sell in Target Zone 4, 83.45 - 82.92. TakeProfit: Target Zone 79.86 - 79.35. StopLoss: 84.30
  2. Buy according to the pattern in Target Zone 79.86 - 79.35. TakeProfit: 84.61. StopLoss: according to the pattern rules.

 _Technical analysis based on margin zones methodology was provided by
an independent analyst_[ _Alex Rodionov_][9] _._

## Oil Price Forecast 2025 – 2050*

The EIA [predicted][13] that, by 2025, Brent crude oil's nominal price
...
[renewable energy][14]. It also predicts economic growth of around 2%
...
high as $200 a barrel. The EIA [forecast][13] Brent oil prices of $214/b
...
they dropped to about $40/b in December before [rising to $123/b][15] in
April 2011. The [Organization for Economic Cooperation and
Development][16] (OECD) previously forecasted that Brent might go as
...
Make sure to create a free demo account on [LiteForex][17]! LiteForex is
...
( {{count}} {{title}} )
   ...
   3. www.liteforex.com/trading/trading-instruments/oil/uscrude/
   4. my.liteforex.com/trading/chart?symbol=USCRUDE
   ...
   8. my.liteforex.com/trading/?category=analysts-opinions&slug=oil-price-prediction-forecast&type=currency
   9. www.liteforex.com/blog/?author=65
   10. my.liteforex.com/trading/chart?symbol=USCrude
   11. www.liteforex.com/blog/?author=72
   12. my.liteforex.com/trading?type=oil
   13. www.eia.gov/outlooks/aeo/index.php
   14. www.thebalance.com/renewable-energy-industry-current-state-trends-outlook-4684187
   15. www.eia.gov/dnav/pet/hist/LeafHandler.ashx?n=PET&s=RBRTE&f=M
   16. www.thebalance.com/organization-economic-cooperation-development-3305871
   17. www.liteforex.com/