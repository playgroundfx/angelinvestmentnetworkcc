...
## Weekly Elliott wave ZCash analysis as of 26.04.2021

The ZECUSD market is developing the global corrective trend as a simple
zigzag A-B-C. There have completed the sub-waves A and B. Wave A is a
five-wave impulse, wave B is a correction shaped as a triple zigzag.
Since March 2020, the market has been forming the initial part of the
upward impulse wave C. There have completed the first two small sub-
waves [1] and [2]. Let us study the structure of the most recent chart
section in more detail in the H8 timeframe.

There is forming the initial part of the upward third wave, which should
end as a five-wave impulse (1)-(2)-(3)-(4)-(5). So far, there have
completed sub-waves (1) and (2), and sub-wave 1 of a smaller degree.
There should be developing the descending corrective wave 2. Correction
2 is unfolding as a simple zigzag [A]-[B]-[C]. The bearish wave [C]
should most likely conclude the entire wave 2 at a level of 158.00,
where wave 2 will be 76.4% of wave 1, according to the Fibo
retracements. Next, the market should start rising to a level higher
than 298.00.

### Weekly [ZECUSD][8] trading plan:

Sell 201.73, TP 158.00
