...
## Weekly Elliott wave Litecoin analysis as of 26.04.2021

The LTCUSD market has been forming a global regular zigzag A-B-C for a
long time. Waves A and C are simple five-wave impulses, and the B wave
is a correction in the form of a bearish triple zigzag. All these waves
look complete. Therefore, over the next few weeks, the price should be
declining in the new bearish trend. Let us study the market structure in
more detail in the eight-hour timeframe.

There should be unfolding the descending double zigzag [W]-[X]-[Y],
which is an element of a larger pattern. The first motive wave [W] may
have completed as a standard zigzag (A)-(B)-(C). There is now unfolding
the initial part of the bullish linking wave [X]. The [X] wave must be
50% of wave [W], so it should end at a level of 268.00. After the
indicated level is reached, the price should turn down and start
declining.

### Weekly [LTCUSD][2] trading plan:

Buy 234.08, TP 268.00
...
The LTC price today is $238.54. This value is interactive, so you will
