...
January 2021. The NEO/USD today’s rate is: $53.80
...
## Weekly Elliott wave NEO analysis as of 31.05.2021

An ascending double zigzag (W)-(X)-(Y) continues unfolding in the
NEOUSD's crypto chart, just like in the past trading weeks. An ascending
actionary wave (W) is complete. The first part of the ultimate actionary
wave in linking wave (X) is developing at the moment. Wave (X) is
forming as double zigzag W-X-Y. Wave W is a triple zigzag, and wave X is
a simple zigzag. Wave Y will most likely develop as double zigzag
[W]-[X]-[Y]. Let’s have a detailed look at the last segment of the chart
on the H8 timeframe.

The price continued moving down after the ascending linking wave X was
formed. Most likely, the bearish wave [W] — the first part of a double
zigzag — is unfolding now. Wave [W] may develop as a simple zigzag
(A)-(B)-(C). The first impulse wave (A) seems to be complete. There may
occur impulse growth in wave C to 77.80 in the near time. At that level,
the size of correction (B) will be 38.2% of wave (A). Then, traders may
see a further market fall.
