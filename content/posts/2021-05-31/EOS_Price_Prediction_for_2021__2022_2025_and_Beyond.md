...
## Weekly Elliott wave EOS analysis as of 31.05.2021

The EOSUSD is probably building a global double zigzag (W)-(X)-(Y) on
the [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) timeframe. The first actionary sub-wave (W) was fully
completed, and the downward linking wave (X) is still unfolding. Wave
(X) may form as double zigzag W-X-Y. The first actionary wave W and
linking wave X are double zigzags and seem to have formed fully. The
ultimate wave Y has just started developing and may have a similar inner
structure. Let’s examine wave Y in detail on the H8 timeframe.

After linking wave X formed as a double zigzag, there was a decline that
suggests a complete impulse wave (A). Next, the market moved in an
ascending direction. An ascending corrective wave (B) may be forming at
the moment. It may unfold as a simple zigzag A-B-C. For that zigzag to
finish forming, sub-wave C is required. Growth in sub-wave C may go up
to 9.40. At that level, the size of wave (B) will be 50% of wave (A)
according to the Fibo ratios. The probability of reaching this ratio is
high.

### Weekly [EOSUSD][2] trading plan structure:
