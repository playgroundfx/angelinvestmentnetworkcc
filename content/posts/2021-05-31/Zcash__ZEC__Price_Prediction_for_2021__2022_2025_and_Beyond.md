...
## Weekly Elliott wave ZCash analysis as of 31.05.2021

The ZECUSD cryptocurrency pair is following a global corrective trend in
the long term. There's a simple zigzag (A)-(B)-(C) forming. Most
probably, its first part — impulse wave (A) — has fully formed. Bearish
correction (B), which may form as double zigzag W-X-Y, is developing at
the moment. Wave W is a triple zigzag, and linking wave X is a double
zigzag. Wave Y has just started developing. It will probably be shaped
like a double zigzag [W]-[X]-[Y]. Let’s have a closer look at the last
segment of the chart.

The price went down after wave X was formed. Most probably, impulse wave
(A) is complete. If it is, there may be corrective growth in wave (B) in
the near time. The price may reach the level of 240.00 and then reverse.
The pair will continue falling in price. Wave (B) will be 50% of impulse
wave (A) at that level. The probability of reaching this ratio is high.
So, we can consider opening long positions to make profits at that
level.

### Weekly [ZECUSD][8] trading plan structure:

Buy 154.43, TP 240.00
