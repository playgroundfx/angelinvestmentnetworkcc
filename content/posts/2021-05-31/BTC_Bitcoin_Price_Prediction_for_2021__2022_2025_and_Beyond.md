...
Bitcoin price today (01.06.2021) is $36 742.52.
...
## Weekly Elliott wave Bitcoin analysis as of 31.05.2021

Most likely, Bitcoin is in a big uptrend in the long term and may form a
simple zigzag (A)-(B)-(C). The first impulse wave (A) might have been
fully completed. It consists of sub-waves 1-2-3-4-5 marked in red. The
first part of a corrective bearish wave is forming at the moment. Its
first part may unfold as a descending impulse 1-2-3-4-5. Only sub-waves
1 and 2, which we can see in the chart, have been formed by now. Let’s
look at the last segment of the chart on the H8 timeframe.

The market started forming the third wave's first part after bearish
wave 1 and zigzag-shaped corrective wave 2 were formed. Descending wave
[1] appears to have completed as an impulse. Two parts of an ascending
correction [2], which may form as a simple zigzag (A)-(B)-(C), might
have already been built. We may see the market growing in the near time
in impulse wave (C) which may end wave [2]'s development at 44,500.00.
Its size will be 50% of wave [1] at that level.

### Weekly [BTCUSD][1] trading plan structure:

Buy 35324.50, TP 44500.00
...
If the current price is at $36 742.52, what is the Bitcoin future value?
...
the current Bitcoin price is at $36 742.52. Usually, it’s a better idea
