...
## Weekly Elliott wave Litecoin analysis as of 11.10.2021
...
It is clear that, after the down impulse wave [A] finished, the price
has started being corrected in wave [B]. The [B] wave should be
unfolding as a simple zigzag (A)-(B)-(C), which is about to end soon.
The upward wave (A) has completed as an impulse, the bearish correction
(B) is a simple zigzag A-B-C. There is unfolding the impulse wave (C),
which should finish around level 232.00, where impulse (A) completed
earlier. One could enter buy trades in the current situation.

### Weekly [LTCUSD][3] trading plan:

Buy 182.85, TP 232.00
...
The Litecoin price today is  $175.10. This value is interactive so that
