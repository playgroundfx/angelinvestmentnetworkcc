...
## Weekly Elliott wave ZCash analysis as of 11.10.2021

The ZECUSD market continues forming the large corrective wave (B) as a
double zigzag W-X-Y. So far, sub-wave W and X have finished, and the
final wave Y is still developing. The Y should also complete as a double
zigzag, like the linking wave X. Its approximate structure is outlined
in the chart, marked with sub-waves [W]-[X]-[Y]. Let us explore the
structure of the first down sub-wave [W], which could be unfolding as a
zigzag (A)-(B)-(C), in the H8 timeframe.

It is clear that the impulse wave (A) and corrective wave (B) have
completed. There is unfolding the initial part of the final wave (C),
which could complete as an impulse 1-2-3-4-5, as outlined in the chart.
The price could be rising in correction 2 to a level of 143.87. Next,
the market will resume declining in sub-waves 3-4-5. In the current
situation, one could enter long trades and take the profit at the end of
correction 2.

### Weekly [ZECUSD][8] trading plan:

Buy 127.20, TP 143.87
