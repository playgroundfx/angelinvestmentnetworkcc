...
The price for today is $64.598. The chart below is interactive, so you
...
## Oil weekly price forecast as of 08.03.2021

The oil correction ended after the price had reached the key support of
the medium-term uptrend at [59.18 – 58.73]. Bears failed to draw the
price lower. Finally, the price reached Target Zone 6 [64.92 – 64.41].
Last week, bulls didn’t consolidate the price above Target Zone 6 [64.92
– 64.41] for the further price rise.

This week, the bullish trend will continue if the traders consolidate
the price above level 64.92. If so, the next upside target will be
Target Zone 7 [70.02 – 69.51].

One could enter new middle-term buy trades when there is a correction
down to the strong support levels. The nearest support is at 63.32. The
trend border is now at [61.10 – 60.64]. The target is at the price high.

### [USCrude][3] Trading ideas for the week:

  1. Buy according to the pattern at level 63.32. TakeProfit: 65.35. StopLoss: according to the pattern rules.
  2. If the price breaks out level 63.32, sell. TakeProfit: Target Zone [61.10 - 60.64]. StopLoss: 64.65.
