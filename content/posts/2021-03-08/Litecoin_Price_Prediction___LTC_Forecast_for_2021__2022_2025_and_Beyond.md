...
## Weekly Elliott wave Litecoin analysis as of 08.03.2021

The LTCUSD market continues forming a multi-year simple zigzag, composed
of three motive sub-waves A-B-C. The [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) timeframe displays the upward
impulse wave A and the bearish corrective wave B, which has completed as
a triple zigzag [W]-[X]-[Y]-[X]-[Z]. After the triple zigzag completed,
the price has started rising in the impulse wave C. So far, there have
finished the sub-waves [1]-[2]-[3], and the corrective wave [4] is still
unfolding. Let us study wave [4] in more detail in the eight-hour
timeframe.

The corrective down wave [4], currently unfolding, should complete as a
simple zigzag (A)-(B)-(C). The bearish impulse wave (A) has ended. Next,
the price has started rising in the corrective wave (B), which looks
like a simple zigzag. The final impulse wave C will conclude the
corrective wave (B). Wave C should end at a level of 212.00, where wave
(B) will reach the Fibonacci ratio of 61.8% of the (A) wave. Next, the
impulse wave (C) will drive the market down. One could enter purchases
with the target at 212.00.

### Weekly [LTCUSD][2] trading plan:

Buy 186.58, TP 212.00
...
The LTC price today is $187.39. This value is interactive, so you will
