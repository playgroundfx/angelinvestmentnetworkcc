...
BTC Price Analysis and Predictions: Bitcoin Price Breakout!Jana Kane
...
Bitcoin price today is $51 621.14.
...
## Weekly Elliott wave Bitcoin analysis as of 08.03.2021

The BTCUSD market is forming a large simple upward zigzag, which has
recently started. The upward impulse wave (A) must have completed; it is
the first motive wave of the zigzag-shaped pattern currently unfolding.
Over the next few weeks, the Bitcoin price should be moving down in the
corrective wave (B). Let us explore the most recent Bitcoin chart
section on the eight-hour timeframe.

After the final impulse wave [5] of 5 finished, the market has started
declining. There could be forming a bearish double zigzag [w]-[x]-[y],
which is an element of a larger corrective pattern. The bearish wave [w]
has completed, and the market is rising in the zigzag-shaped linking
wave [x]. This week, the price should reach level 54500.00, where wave
[x] will reach 76.4% Fibonacci level of wave [w]. Next, the market could
start declining in the final wave [y], as outlined in the chart.

### Weekly [BTCUSD][1] trading plan:

Buy 50514.26, TP 54500.00
...
If the current price is at $51 621.14, what is the Bitcoin future value?
...
the current Bitcoin price is at $51 621.14. Usually, it’s a better idea
