...
## Weekly Elliott wave Ripple analysis as of 08.03.2021

The XRPUSD continues forming the global corrective wave B as a triple
zigzag [W]-[X]-[Y]-[X]-[Z]. Wave B is an element of the simple upward
zigzag A-B-C of a larger degree. There is now forming the second linking
wave [X] as a contracting triangle (A)-(B)-(C)-(D)-(E). Let us examine
the most recent chart section in a shorter timeframe.

Within the triangle pattern of a larger degree, there have completed the
sub-waves (A)-(B)-(C), each of which is a zigzag. According to the
market structure, wave (D) should be a bearish double zigzag W-X-Y.
There has recently completed the linking wave X as a triple zigzag. The
first leg of wave Y, impulse [A], has also finished. There should soon
end the upward corrective wave [B], and the market will start declining
in the [C] impulse to a level of 0.300. At this level, wave (D) will be
76.4% of wave (C).
...
The Ripple price today is $0.47449. Looking at the full price chart
