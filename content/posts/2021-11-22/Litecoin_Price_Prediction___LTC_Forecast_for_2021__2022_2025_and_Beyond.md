...
## Weekly Elliott wave Litecoin analysis as of 22.11.2021

The LTCUSD market has completed the impulse upwave C, concluding a
bullish simple zigzag A-B-C. There should be forming a horizontal
pattern as a contracting triangle [A]-[B]-[C]-[D]-[E], with sub-waves
[A]-[B] completed inside. There is developing the down wave [C]. Let us
explore its initial part in the eight-hour timeframe.

As clear from the chart, the corrective wave [B] finished in early
November as a simple zigzag composed of sub-waves (A)-(B)-(C). After the
completion of the [B] wave, the market has turned down and started
declining in the [C] wave, likely unfolding as a double zigzag
(W)-(X)-(Y), as outlined in the chart. The motive sub-wave (W) is
complete, the linking wave (X) has just started, Therefore, the market
should continue rising in the linking wave (X) to a level of 272.00,
where the (X) wave will be 76.4% of wave (W).

### Weekly [LTCUSD][3] trading plan:

Buy 224.49, TP 272.00
...
The Litecoin price today is  $207.60. This value is interactive so that
