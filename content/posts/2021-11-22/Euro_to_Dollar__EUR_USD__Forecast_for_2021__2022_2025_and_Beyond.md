...
The current rate of the EUR/USD pair is $1.12353. Below, you can see an
...
## Euro/dollar weekly price forecast as of 22.11.2021

Last week, the euro downtrend continued. The market broke out Target
Zone 5. Next, following the retest of the zone, the price broke through
the weekly low and headed towards Target Zone 6, 1.1210 - 1.1192. Target
Zone 6 is the primary downside target in the medium-term downtrend this
week. After the target is reached, the price could start rising as the
euro-dollar will be oversold.

I recommend entering new short trades on the correction towards the key
resistance of the downtrend 1.1443 - 1.1426.

It will be relevant to buy the euro if the price breaks out the local
high of last week 1.1368 and consolidates above. In this case, there
will be a double bottom pattern to buy, and one could use it to enter
long trades.
