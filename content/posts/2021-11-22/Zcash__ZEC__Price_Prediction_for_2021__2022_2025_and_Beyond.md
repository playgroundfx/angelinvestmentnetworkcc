...
## Weekly Elliott wave ZCash analysis as of 22.11.2021

The ZECUSD market continues forming the multi-year corrective wave (B)
as a double zigzag W-X-Y. The first two sub-waves W and X have
completed. Wave W is a triple zigzag [W]-[X]-[Y]-[X]-[Z]. The linking
wave X is a double zigzag [W]-[X]-[Y]. There is unfolding the final
motive wave Y as a simple zigzag [A]-[B]-[C]. Let us study the most
recent chart section in the H8 timeframe.

The first impulse wave [A] has finished in the potential simple zigzag
[A]-[B]-[C]. Corrective wave [B] is currently unfolding as a zigzag
(A)-(B)-(C), where the final wave (C) is currently forming, namely, its
fifth leg. The market could rise in sub-wave 5 to a level of 217.00.
Next, the market should turn down and start declining, as outlined in
the chart. One could enter buy trades in the current situation.

### Weekly [ZECUSD][8] trading plan:

Buy 184.90, TP 217.00
