...
## Weekly Elliott wave Ethereum analysis as of 23.08.2021

The ETHUSD pair must have completed the multi-year simple zigzag A-B-C.
After the bullish impulse wave C finished, the Ethereum price has
started falling in the new bearish trend. There should be forming the
initial part of the descending simple zigzag A-B-C. The down wave A is
likely to have formed, and the upward correction B is about to end soon.
Let us explore the most recent chart section in the eight-hour
timeframe.

It is clear that the ascending corrective wave B is composed of three
major sub-waves [A]-[B]-[C]. The first two legs of the B wave look
complete. There is unfolding the upward sub-wave [C] as a five-wave
impulse (1)-(2)-(3)-(4)-(5). Sub-waves (1)-(2)-(3)-(4) seem to have
completed, and the final sub-wave (5) should developing up to a level of
3670.00. At this level, wave B will be 76.4% of wave A.

### Weekly [ETHUSD][2] trading plan:

Buy 3249.92, TP 3670.00
...
ETH is traded at $3 214.34. Below you can see how the price of ETH
