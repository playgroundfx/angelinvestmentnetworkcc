...
## Weekly Elliott wave NEO analysis as of 15.03.2021

Like other major cryptocurrencies, the NEOUSD market is forming a large
simple zigzag A-B-C. The first two legs of the zigzag have completed.
Wave A is an impulse, and correction B is a triple zigzag. There is now
developing the initial part of the final motive wave C, which should be
an impulse. Let us see the most recent chart section in more detail in
the eight-hour timeframe.

In the most recent chart section, it is clear that, after the corrective
wave [2], composed of the sub-waves (W)-(X)-(Y), finished, the market
has started rising in the initial leg of the new impulse wave. There has
completed the bullish sub-wave (1) as a simple five-wave impulse. There
is now forming the corrective wave (2), which could end as a simple
downward zigzag A-B-C. In the near future, the impulse wave [C] should
complete the B correction at a level of around 45.80. Next, there will
start the bearish wave C, which should be unfolding as it is outlined in
the chart. At level 45.80, wave B will reach the Fibonacci ratio of
61.8% of the A impulse.
