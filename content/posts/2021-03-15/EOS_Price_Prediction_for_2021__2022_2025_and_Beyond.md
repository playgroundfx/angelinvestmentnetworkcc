...
## Weekly Elliott wave EOS analysis as of 15.03.2021

The EOSUSD is also forming a multi-year zigzag-shaped trend. After the
large impulse wave A completed, the market has started forming bearish
corrective wave B as a triple zigzag [W]-[X]-[Y]-[X]-[Z]. This zigzag
has been unfolding for more than two years. At the time of writing,
there is developing the initial sub-wave of the final motive wave [Z],
which could end as a double zigzag (W)-(X)-(Y). Let us study the most
recent chart section in more detail in the H8 timeframe.

In early February 2021, the linking upwave [X] completed as a double
zigzag (W)-(X)-(Y). Next, the market turned down and started forming a
new corrective wave. There is likely to be forming a double zigzag, with
the first motive wave (W) completed inside. The linking wave (X) could
have a complex structure of a double zigzag and end the entire pattern
at a level of around 4.68. At this level, wave (X) will be 61.8% of wave
(W), according to the Fibonacci retracements.
