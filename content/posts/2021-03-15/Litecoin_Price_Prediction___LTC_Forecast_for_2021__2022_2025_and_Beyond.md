...
## Weekly Elliott wave Litecoin analysis as of 15.03.2021

The LTCUSD market continues forming the global simple zigzag A-B-C. The
first two sub-waves of this zigzag, waves A and B, have finished. The A
wave is a bullish impulse, and the B correction is a triple zigzag.
There should be unfolding the upward impulse wave C composed of the sub-
waves [1]-[2]-[3]-[4]-[5]. The first two sub-waves [1] and [2] have
completed, and there is now forming impulse [3], which should end soon.
Let us study the most recent chart section in more detail in the eight-
hour timeframe.

In the upward impulse wave [3], there have completed the first four
legs: impulse sub-waves (1) and (3), and corrective sub-waves (2) and
(4). Corrective wave (4) is a double zigzag w-x-y. There is unfolding
the final bullish wave (5), namely, its final, fifth wave. After a short
corrective wave [4] finishes, the price could rise up to a level of
248.00. At this level, wave 5 of (5) will reach the Fibonacci
retracement of 76.4% of wave 3. An approximate trajectory of the
Litecoin future price movement is outlined in the chart.

### Weekly [LTCUSD][2] trading plan:

Buy 219.58, TP 248.00
...
The LTC price today is $202.37. This value is interactive, so you will
