...
Bitcoin price today ({var_date}) is $56 497.77.
...
## Weekly Elliott wave Bitcoin analysis as of 15.03.2021

In the [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) BTCUSD timeframe, there is unfolding the impulse wave (A),
which started five years ago. The (A) wave is the first leg in the
global zigzag. Four legs out of five have completed within the (A) wave.
The market is rising in the final wave 5, which is unfolding as a five-
wave impulse [1]-[2]-[3]-[4]-[5].  Let us explore the impulse structure
in the eight-hour timeframe.

The first four sub-waves have finished in impulse 5, and sub-wave [5] is
still developing. In late January 2021, the market completed corrective
sub-wave (4) as a triple zigzag w-x-y-xx-z. Next, the market continued
rising in the impulse wave (5) of [5]. There is likely to be developing
a small impulse wave 5 of a lower degree, which could conclude the
bullish trend at a level of about 69500.00. At the indicated level, the
waves 3 and 5 of a smaller degree will be 100% equal, according to
Fibonacci retracements.

### Weekly [BTCUSD][1] trading plan:

Buy 60042.50, TP 69500.00
...
If the current price is at $56 497.77, what is the Bitcoin future value?
...
the current Bitcoin price is at $56 497.77. Usually, it’s a better idea
