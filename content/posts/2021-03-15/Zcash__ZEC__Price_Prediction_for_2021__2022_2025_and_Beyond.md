...
## Weekly Elliott wave ZCash analysis as of 15.03.2021

The ZECUSD market is forming the global simple zigzag A-B-C. The first
impulse wave A has completed, as well as the bearish corrective wave B.
Wave B is a triple zigzag [W]-[X]-[Y]-[X]-[Z]. There is currently
unfolding the first leg of the final impulse wave C. Let us study the
most recent chart section in more detail in the H8 timeframe.

The above chart displays the final part of the impulse wave [1], which
has been followed by the corrective growth in wave [2]. Wave [2] has
completed as a double three composed of the sub-waves (W)-(X)-(Y). There
is now developing the initial part of the impulse wave [3]. So far, wave
(1) has completed as a five-wave impulse. There is now forming
correction (2), namely, its middle part – the zigzag-shaped wave B. In
the near future, the price should be rising in the [C] impulse to a
level of 166.00, where wave B will be 76.4% of the bearish wave A. One
could enter long positions.

### Weekly [ZECUSD][8] trading plan:

Buy 147.32, TP 166.00
