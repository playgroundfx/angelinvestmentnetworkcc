...
## Weekly Elliott wave Ethereum analysis as of ****21.06.2021

The ETHUSD market is forming a global simple zigzag A-B-C. The sub-waves
A and C are simple impulses, corrective wave B is a bearish triple
zigzag [W]-[X]-[Y]-[X]-[Z]. The most recent chart section displays the
price decline in the initial part of the new bear trend. There could be
unfolding a zigzag A-B-C in the medium term. Let us look at the most
recent chart section in the eight-hour timeframe.

It is clear from the chart that there is forming an impulse down wave A,
with the first four sub-waves [1]-[2]-[3]-[4] completed inside. The
final wave 5 looks half-complete, so the market should continue
declining in the sub-waves (3)-(4)-(5), as outlined in the chart. The
Ethereum price should reach level 1700.00, the previous low. Next, the
market will start rising in the bullish correction B. One could enter
sell trades in the current situation.

### Weekly [ETHUSD][1] trading plan:

Sell 2084.82, TP 1700.00
...
ETH is traded at $1 921.60. Below you can see how the price of ETH
