...
## Weekly Elliott wave Litecoin analysis as of 21.06.2021

The LTCUSD market situation is similar to that of Ethereum. There has
recently finished a global zigzag-shaped trend. Sub-waves A and C are
bullish impulses. The bearish correction B is a triple zigzag
[W]-[X]-[Y]-[X]-[Z]. The price is declining in the initial part of the
new downtrend. There should be developing a zigzag [A]-[B]-[C]. Let us
study the most recent chart section in more detail in the eight-hour
timeframe.

The descending wave [A] is likely to be an impulse. The corrective wave
(4) has recently completed as a skewed triangle A-B-C-D-E, as the
construction lines are directed downward, like the primary wave of a
larger degree. After the triangle finishes, the market usually moves in
the direction it was going ahead of the triangle. Therefore, the market
should soon be declining in wave (5). Wave (5) could end at a level of
74.60, where it will be 38.2% of wave (3). Next, there will be unfolding
corrective wave [B], as outlined in the chart.

### Weekly [LTCUSD][2] trading plan:

Sell 146.21, TP 74.60
...
The Litecoin price today is $132.33. This value is interactive so that
