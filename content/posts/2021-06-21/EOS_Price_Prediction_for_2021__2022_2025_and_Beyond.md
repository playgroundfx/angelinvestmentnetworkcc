...
## Weekly Elliott wave EOS analysis as of 21.06.2021

The EOSUSD pair must be forming a global corrective trend as a double
zigzag (W)-(X)-(Y). There has completed the first motive wave (W). The
bearish linking wave (X) is currently unfolding. The (X) wave should be
developing as a double zigzag W-X-Y, whose sub-waves are also double
zigzags. The market must have started forming the final wave Y. Let
study the initial sub-wave of the Y wave, wave [W], in the eight-hour
timeframe.

The [W] wave should be developing as a simple zigzag (A)-(B)-(C). The
chart displays the descending wave (A) unfolding as an impulse. The (A)
impulse is about to end soon, its final leg, impulse 5 is forming. The
price should be declining in wave [5] of 5 to a level of 2.40, marked by
corrective wave 2. After that, the price should turn up and start rising
in the corrective wave [B], as outlined in the chart.
