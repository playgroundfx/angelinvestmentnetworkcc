...
## Weekly Elliott wave ZCash analysis as of 21.06.2021

The ZECUSD must be forming a simple long-term zigzag (A)-(B)-(C). The
first large sub-wave of this zigzag, impulse (A), has completed. There
is forming the second part of the zigzag, the corrective wave (B).
Correction (B) must be unfolding as a double zigzag W-X-Y. Wave W is a
triple zigzag, linking wave X is a double zigzag [W]-[X]-[Y]. The final
wave Y has recently started forming as a double zigzag [W]-[X]-[Y]. Let
us analyze the first motive wave [W] in more detail.

Wave [W] could finish as a regular zigzag (A)-(B)-(C). The first sub-
wave of the zigzag, impulse (A), is about to end soon. The market should
be declining in sub-wave 5 to a level of 85.70, where the bearish
impulse 3 finished. After level 85.70 is reached, the bullish correction
(B) should start. Wave (B) could retrace wave (A) by 38.2%, as outlined
in the chart. One could enter sell trades with a target at 85.70 under
the current conditions.

### Weekly [ZECUSD][8] trading plan:

Sell 121.41, TP 85.70
