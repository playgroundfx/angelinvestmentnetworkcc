...
Bitcoin price today (28.09.2021) is $42 728.95.
...
## Weekly Elliott wave Bitcoin analysis as of 27.09.2021

The BTCUSD market continues forming the long-term simple zigzag, with
the first sub-wave (A) completed inside as a regular five-wave impulse
1-2-3-4-5. After the (A) completed, the market has started declining.
There should be forming a simple descending zigzag [A]-[B]-[C]. The
first two parts of the zigzag, impulse [A] and bullish correction [B]
must have completed. Let us study the market situation in more detail in
the eight-hour timeframe.

The bullish correction [B] is a zigzag composed of three sub-waves
(A)-(B)-(C). There is now unfolding the initial part of the new bearish
sub-wave, which must be an impulse. At the time of writing, there have
completed the sub-waves of a smaller degree (1)-(2) and 1-2. The market
should continue declining to a level below 37500.00, marked by
correction (B). One could enter sell trades in the current situation.

### Weekly [BTCUSD][1] trading plan:

Sell 41441.00, TP 37500.00
...
If the current price is at $42 728.95, what is the Bitcoin future value?
...
the current Bitcoin price is at $42 728.95. Usually, it’s a better idea
