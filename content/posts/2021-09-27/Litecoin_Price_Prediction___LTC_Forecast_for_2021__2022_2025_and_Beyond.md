...
## Weekly Elliott wave Litecoin analysis as of 27.09.2021

The LTCUSD market completed the bullish trend. The market must have
completed the global simple zigzag A-B-C. The market has turned down and
started declining in the new bearish trend. There should be forming a
descending zigzag [A]-[B]-[C], where sub-waves [A] and [B] completed,
and the down wave [C] is now forming. Let us study the most recent chart
section in more detail in the eight-hour timeframe.

It is clear from the H8 LTCUSD chart that wave [A] is a bearish impulse
(1)-(2)-(3)-(4)-(5). Corrective wave [B] is an upward simple zigzag
(A)-(B)-(C). The most recent chart section displays that there is
developing the initial part of the final bearish impulse, with sub-waves
(1)-(2) completed inside. In the next few days, the Litecoin price
should be going down to a level of 103.00, marked by wave [A]. One could
enter sell trades.

### Weekly [LTCUSD][3] trading plan:

Sell 142.89, TP 103.00
...
The Litecoin price today is  $147.45. This value is interactive so that
