...
## Weekly Elliott wave EOS analysis as of 27.09.2021

The EOSUSD market should be forming the middle part of the global
corrective trend, unfolding as a double zigzag; that is, the linking
wave (X) is currently forming. The (X) seems to be unfolding as a double
zigzag W-X-Y. The final motive wave Y, like the previous two ones,
should be a double zigzag, as outlined in the chart. The first sub-wave
[W] has been half-complete so far. Let us study the market structure in
more detail in the H8 timeframe.

Wave [W] could be a simple zigzag. It is clear from the eight-hour
timeframe that the first two sub-waves have finished within wave [W];
they are impulse (A), and a zigzag-shaped correction (B). There is
developing the initial part of the final sub-wave, which could be an
impulse. The EOS price should be moving down in sub-wave 3 to a level
below 1.95, as outlined in the chart.
