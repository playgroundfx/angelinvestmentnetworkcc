...
January 2021. The NEO/USD today’s rate is: $37.75
...
## Weekly Elliott wave NEO analysis as of 27.09.2021

The NEOUSD market is forming a long-term corrective trend as a double
combination. The first motive wave (W) completed in late 2017 - early
2018. Since then, the market has been moving down forming the linking
wave (X). The (X) wave looks like a double zigzag W-X-Y, where the first
two legs completed. There has started forming the final motive wave Y.
Its expected structure is outlined in the chart. Let us study the first
...
market is declining, as the final potential impulse wave (C) must have
started. The NEO price should be going down to a level below 24.50,
where wave 3 should end. Next, following a short correction 4, the
market will continue declining in the final wave 5, as outlined in the
chart.
