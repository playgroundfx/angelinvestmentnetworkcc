...
## Weekly Elliott wave Ripple analysis as of 27.09.2021

The XRPUSD market is forming the middle part of the simple global zigzag
A-B-C, that is correction B unfolding as a double zigzag [W]-[X]-[Y].
The motive wave [W] is a triple zigzag. Wave [X] completed as a double
zigzag (W)-(X)-(Y). There is now forming the initial part of the final
motive wave [Y], which could be a double zigzag. Let us study the chart
structure in more detail in the eight-hour timeframe.

It is clear from the eight-hour timeframe that two sub-waves (W) and (X)
have completed in wave [Y]. Both waves are standard zigzags composed of
sub-waves A-B-C. The market is now declining in the new sub-wave
unfolding as an impulse. There have completed sub-waves 1 and 2 of the
new impulse. The price should be declining in the third wave to a level
below 0.687. One could enter sell trades in the current situation.
...
The Ripple price today on 28.09.2021 is $0.92615. Looking at the full
