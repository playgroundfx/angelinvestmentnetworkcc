...
## Weekly Elliott wave Ethereum analysis as 27.09.2021

The [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) ETHUSD price chart displays the structure of a long-term
uptrend completed as a simple zigzag. There is forming the initial part
of the new bear trend. There must be forming zigzag A-B-C, with the
first two legs completed inside. The bearish impulse C is currently
developing. Let us explore the most recent chart section in the eight-
hour timeframe.

The upward corrective wave B seems to have completed as a simple zigzag
[A]-[B]-[C]. After this correction completed, the market has turned down
and started forming the beginning of the bearish wave. Sub-waves [1] and
[2] have completed, so the market should continue declining in the third
wave towards a level of 1715.00, where the [B] correction and impulse A
finished earlier. Therefore, it is relevant to enter sell trades under
the current conditions.

### Weekly [ETHUSD][2] trading plan:

Sell 2781.23, TP 1715.00
...
ETH is traded at $2 955.93. Below you can see how the price of ETH
