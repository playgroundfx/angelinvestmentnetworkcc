...
## Weekly Elliott wave Litecoin analysis as of 15.11.2021

The LTCUSD market has finished the global simple zigzag A-B-C. Next, the
price started declining in the new bearish trend. There could be forming
the beginning of the zigzag [A]-[B]-[C]. So far, the first leg, the [A]
impulse has completed. The bullish correction [B] is still developing.
Let’s study the most recent chart section in the eight-hour timeframe.

It is clear from the H8 timeframe that corrective wave [B] is forming as
a standard zigzag (A)-(B)-(C). Sub-waves (A) and (B) have finished as a
simple impulse and a simple zigzag. There is unfolding the bullish
impulse wave (C), namely its final wave 5. Sub-waves [1]-[2]-[3]-[4]
have finished within wave 5. The Litecoin price should be rising in the
impulse sub-wave [5] to a level of 296.00. At this level, wave [B] will
reach the Fibonacci ratio of 61.8% of the bearish impulse wave [A]. One
could enter buy trades in the current situation.

### Weekly[ LTCUSD][3] trading plan:

Buy 255.36, TP 296.00
...
The Litecoin price today is  $261.20. This value is interactive so that
