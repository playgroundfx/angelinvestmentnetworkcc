...
## Weekly Elliott wave ZCash analysis as of 05.07.2021

The ZECUSD market is developing a global bullish zigzag (A)-(B)-(C). The
first impulse wave (A) finished in late 2017. Since then, the market has
been forming the bearish correction (B) as a double zigzag W-X-Y. Sub-
wave W is a triple zigzag, the upward linking wave X is a double zigzag.
There is developing the beginning of the final motive wave X, which
could complete as a double zigzag as is outlined in the chart. Let us
study the structure of the most recent chart section in more detail in
the H8 timeframe.

The market has been declining in the impulse wave (A) over the last two
months. The (A) wave is composed of five sub-waves 1-2-3-4-5 and is
likely to have completed. Therefore, the price should be rising in the
corrective wave (B), which should end at a level of 193.30. At this
level, wave (B) will be 38.2% of wave (A). After the (B) correction
finishes, the price will resume declining in the (C) impulse, as is
outlined in the chart.

### Weekly [ZECUSD][8] trading plan:

Buy 117.17, TP 193.30
