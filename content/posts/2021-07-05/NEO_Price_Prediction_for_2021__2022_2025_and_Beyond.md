...
January 2021. The NEO/USD today’s rate is: $36.14
...
## Weekly Elliott wave NEO analysis as of 05.07.2021

The NEOUSD has been developing a global double zigzag (W)-(X)-(Y) over
many years. There is unfolding the (X) wave as a double zigzag W-X-Y.
Sub-wave W finished in early 2020 as a triple zigzag. The zigzag-shaped
wave X was developing until spring 2021, it seems to have completed.
There must be developing the initial part of the final motive wave Y,
which could be a double zigzag, as outlined in the chart. Let us study
the chart structure in more detail in the eight-hour timeframe.

It is clear from the most recent chart section that there is developing
the first motive wave [W] as a simple zigzag (A)-(B)-(C). The descending
wave (A) must have completed as an impulse 1-2-3-4-5. If so, the price
should be rising in the (B) correction to a level of 69.40, where wave
(B) will retrace wave (A) by 38.2%. One could enter long trades in the
current situation.
