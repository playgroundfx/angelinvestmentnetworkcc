...
Bitcoin price today (06.07.2021) is $33 933.65.
...
## Weekly Elliott wave Bitcoin analysis as of 05.07.2021

The BTCUSD market seems to have completed the impulse upwave (A),
composed of sub-waves 1-2-3-4-5. The market has started forming the
initial part of the new bear trend. There should be unfolding a zigzag
[A]-[B]-[C]. The first leg of this zigzag, sub-wave [A], should have
completed. The price should be rising in the [B] correction to a level
of 46700.00. Next, it could start falling to a level below 28570.00,
marked by the [A] wave. Let us study the most recent chart section in
more detail in the eight-hour timeframe.

It is clear from the H8 timeframe that the bearish wave [A] is a five-
wave impulse. Corrective wave (4) of [A] is a double three W-X-Y. There
must be unfolding the first leg of the bullish correction [B]. The [B]
wave could be a regular zigzag (A)-(B)-(C). The (A) wave is unfolding as
a leading diagonal. The entire correction [B] could end at a level of
46700.00, where it will retrace the [A] wave by 50%. An approximate
trajectory of the Bitcoin future price movement is outlined in the
chart.

### Weekly [BTCUSD][1] trading plan:

Buy 35500.50, TP 46700.00
...
If the current price is at $33 933.65, what is the Bitcoin future value?
...
the current Bitcoin price is at $33 933.65. Usually, it’s a better idea
