...
## Weekly Elliott wave EOS analysis as of 05.07.2021

The EOSUSD market is forming a long-term double zigzag. The [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/)
timeframe displays the final part of the first motive wave (W). There is
unfolding the descending wave (X) as a double zigzag W-X-Y. The first
two sub-waves have completed, and the final motive wave Y is still
developing. The Y wave should complete as a double zigzag, like waves W
and X. Let us study the chart in more detail in the H8 timeframe.

The bearish wave (A) has completed as a five-wave impulse within the new
descending zigzag. Next, the price has started rising. There could be
developing the upward corrective wave (B). It is difficult to predict
the exact structure of the (B) wave, but we could expect it to end at a
level of 7.50, where wave (B) will be 38.2% of wave (A). It is a common
ratio in zigzags. Therefore, one could enter purchases in the current
situation.
