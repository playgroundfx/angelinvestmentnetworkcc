...
The current rate of the EUR/USD pair is $1.18611. Below, you can see an
...
## Euro/dollar weekly price forecast as of 05.07.2021

Last week, the EURUSD downtrend started and the price broke out Target
Zone 2, 1.1914 – 1.1896 and broke through the low of the previous week.
This week, the target for medium-term sell trades is Target Zone 3,
1.1738 – 1.1720.

It is relevant to enter short trades at good prices on the correction
after the price tests the resistance 1.1957 – 1.2000.

The correction up is signaled by the RSI convergence with the price
chart (the indicator and the price chart go in the same direction).

### [EURUSD][1] Trading ideas for the week:

Sell according to the pattern in the zone of 1.2000 – 1.1957.
TakeProfit: 1.1827, Target Zone 3, 1.1738 – 1.1720. StopLoss: according
