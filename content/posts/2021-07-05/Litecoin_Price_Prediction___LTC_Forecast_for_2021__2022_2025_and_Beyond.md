...
## Weekly Elliott wave Litecoin analysis as of 05.07.2021

The LTCUSD market must have finished forming the global simple zigzag
A-B-C. Waves A and C are bullish impulses, and the B correction is a
bearish triple zigzag [W]-[X]-[Y]-[X]-[Z]. After the upward wave C
completed, the price has been falling, which could mean the beginning of
a new downtrend. There should be developing the initial part of the
simple descending zigzag [A]-[B]-[C]. Let us study the most recent chart
section in more detail in the eight-hour timeframe.

The H8 displays the structure of the down wave [A], which is a simple
impulse composed of five sub-waves (1)-(2)-(3)-(4)-(5). Sub-wave (4) is
a horizontal correction completed as a skewed triangle. The construction
lines of the triangle are directed down as the entire [A] wave. There is
developing correction [B] as a simple pattern. There is forming the
first sub-wave (A) as a leading diagonal. The entire correction [B]
could end at level around 222.00. At this level, wave [B] will be 38.2%
of the [A]. An approximate trajectory of the Litecoin future price
movement is outlined in the chart.

### Weekly [LTCUSD][3] trading plan:

Buy 143.50, TP 222.00
...
cryptocurrencies. As of now, the rewards per block are [12.5 coins][7]
...
The Litecoin price today is  $139.22. This value is interactive so that
...
( {{count}} {{title}} )
   ...
   7. www.[Litecoin](https://www.playgroundfx.com/blog/litecoin-creator/)blockhalf.com/
