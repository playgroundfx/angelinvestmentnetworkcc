...
Bitcoin price today (31.08.2021) is $48 480.33.
...
## Weekly Elliott wave Bitcoin analysis as of 30.08.2021

The [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) BTCUSD chart displays the structure of the upward wave (A)
completed as a five-wave impulse. Next, the corrective wave has started
developing. There could be forming a regular zigzag, with the sub-wave
[A] completed and the upward correction [B] developing inside. Let us
study the most recent section in more detail in the H8 chart.

The down wave [A] is an impulse (1)-(2)-(3)-(4)-(5). The upward
correction [B], which is about to end soon, is unfolding as a simple
zigzag (A)-(B)-(C). The price should go up to a level of 51100.00, where
the bullish impulse wave (C) will finish. At the indicated level, wave
[B] will reach the Fibonacci ratio of 61.8% of the [A] wave. Corrections
in zigzags often finish at such a ratio. Therefore, this level is highly
likely to be reached by the price.

### Weekly [BTCUSD][1] trading plan:

Buy 48507.07, TP 51100.00
...
If the current price is at $48 480.33, what is the Bitcoin future value?
...
the current Bitcoin price is at $48 480.33. Usually, it’s a better idea
