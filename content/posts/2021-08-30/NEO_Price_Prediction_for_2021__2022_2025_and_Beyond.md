...
January 2021. The NEO/USD today’s rate is: $53.68
...
## Weekly Elliott wave NEO analysis as of 30.08.2021

The [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) NEOUSD chart displays the middle leg of the long-term
corrective trend. There should be unfolding a double zigzag, with the
linking wave (X) forming inside. Wave (X) should be developing as a
double combination W-X-Y, where the first two sub-waves have finished.
The NEO price is now declining in the inceptive part of the motive wave
Y. Its expected future structure is outlined in the chart. Let study the
most recent chart section in more detail in the H8 timeframe.

The most recent chart section displays the descending wave [W],
unfolding as a simple zigzag (A)-(B)-(C). There is forming the
corrective wave (B), namely, its final impulse sub-wave C. The price
should go up to 69.40; next, the market will turn down and start
declining in the impulse wave (C), as outlined in the chart. At level
69.40, wave (B) will retrace the (A) wave by 38.2%, therefore, the price
will likely reach the indicated level.
