...
## Weekly Elliott wave EOS analysis as of 30.08.2021

The EOSUSD market is forming the middle leg of the global double zigzag,
this is the linking wave (X). The descending wave (X) is likely to end
as a double combination W-X-Y, whose sub-waves should be double zigzags.
Sub-waves W and X have finished, and the final motive wave Y has just
started. An approximate trajectory of the EOS future price movement is
outlined in the chart. Let us explore the structure of the first wave
[W] in the H8 timeframe.

It is clear from the eight-hour timeframe that the market is forming a
simple descending zigzag. In late June, the down wave (A) completed as
an impulse 1-2-3-4-5. Next, the price has started rising. There could be
forming the bullish correction (B) as a simple zigzag, which should soon
finish. There should be unfolding the final, fifth, leg of the impulse
upwave C, which could conclude the entire correction (B) at a level of
7.50. At this level, wave (B) will be 38.2% of wave (A).
