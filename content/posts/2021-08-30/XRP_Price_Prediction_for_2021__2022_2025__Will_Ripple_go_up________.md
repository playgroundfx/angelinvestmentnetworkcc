...
## Weekly Elliott wave Ripple analysis as of 30.08.2021
...
wave. There must forming a large double zigzag [W]-[X]-[Y]. So far, the
sub-waves [W]-[X] completed. Sub-wave [Y] has just started forming and
could end as a double zigzag (W)-(X)-(Y). Let us study the chart
...
The Ripple price today on 31.08.2021 is $1.14186. Looking at the full
