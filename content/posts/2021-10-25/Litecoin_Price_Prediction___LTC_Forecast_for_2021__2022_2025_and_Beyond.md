...
## Weekly Elliott wave Litecoin analysis as of 25.10.2021

The LTCUSD market has finished the multi-year corrective trend as a
long-term simple zigzag A-B-C. There is developing a new downtrend.
There must be forming a bearish simple zigzag [A]-[B]-[C]. At the time
of writing, the first leg of the zigzag, impulse [A], has completed. The
upward corrective wave [B] is currently developing. Let us study the
structure of the [B] wave in the eight-hour timeframe.

The [B] wave seems to be unfolding as a simple zigzag (A)-(B)-(C). Wave
(A) is a simple impulse composed of sub-waves 1-2-3-4-5. Corrective wave
(B) has finished as a simple zigzag A-B-C. The price is rising in the
impulse upwave (C) composed of sub-waves 1-2-3-4-5. The price could be
corrected down in sub-wave 4 of a smaller degree. Next, the price will
resume rising in wave 5 to a level of 232.00. This is the previous low
marked by wave (A).

### Weekly [LTCUSD][3] trading plan:

Buy 196.33, TP 232.00
...
The Litecoin price today is  $194.60. This value is interactive so that
