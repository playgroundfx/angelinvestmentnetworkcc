...
## Weekly Elliott wave ZCash analysis as of 25.10.2021

The ZECUSD market is forming the long-term global zigzag (A)-(B)-(C).
There is forming the corrective wave (B) as a double zigzag W-X-Y. Wave
W is a triple zigzag [W]-[X]-[Y]-[X]-[Z]. The linking wave X is a double
zigzag [W]-[X]-[Y]. There is developing the bearish wave Y, possibly, as
a simple zigzag [W]-[X]-[Y], as outlined in the chart. The impulse wave
[A] has completed, and the [B] correction is still unfolding. Let us
study the most recent chart section in the H8 timeframe.

It is clear from the eight-hour chart that the final element of the
impulse wave [A] is an ending diagonal. Next, the market has started
rising in the corrective wave [B], unfolding as a simple zigzag
(A)-(B)-(C), where the first two sub-waves have finished. The price
should continue rising in sub-waves 3-4-5 to a level of 226.00, as
outlined in the chart. At this level, wave [B] will retrace the [A] wave
by 50%. One could enter purchases in the current situation.

### Weekly [ZECUSD][8] trading plan:

Buy 186.87, TP 226.00
