...
January 2021. The NEO/USD today’s rate is: $56.50
...
## Weekly Elliott wave NEO analysis as of 16.08.2021

The NEOUSD market should be forming a double zigzag, with the first
motive wave (W) completed inside. There is now unfolding the bearish
liking wave (X) as a double zigzag W-X-Y, which will be concluded by the
Y wave. The Y wave has recently started, its expected structure is
outlined in the chart. Let study the future structure of the potential
[W] wave in the H8 timeframe.

The [W] is expected to complete as a simple zigzag (A)-(B)-(C). After
the bearish impulse wave (A) completed, the market has started rising in
correction (B). The (B) should finish as a zigzag A-B-C at a level of
69.40. At this level, wave (B) will be 38.2% of wave (A). One could
enter buy trades with the target at 69.40.
