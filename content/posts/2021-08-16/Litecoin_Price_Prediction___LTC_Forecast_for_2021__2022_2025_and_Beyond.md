...
## Weekly Elliott wave Litecoin analysis as of 16.08.2021

The LTCUSD market situation is similar to that of the ETHUSD. The market
has finished a large zigzag A-B-C. The Litecoin price is now declining
in the new bearish trend. There must be forming a new zigzag composed of
sub-waves [A]-[B]-[C]. So far, there has finished its first sub-wave
[A], and the upward correction [B] is developing. Let us study the most
recent chart section in more detail in the eight-hour timeframe.

The down wave [A] is a five-wave impulse (1)-(2)-(3)-(4)-(5), where the
corrective wave (4) is a skewed triangle. There is developing an upward
correction [B] as a zigzag (A)-(B)-(C). Sub-waves (A) and (B) have
finished, and the (C) wave should end soon at a level of 221.00, where
wave [B] will be 38.2% of wave [A]. Next, the market will turn down and
resume declining.

### Weekly [LTCUSD][3] trading plan:

Buy 186.81, TP 221.00
...
The Litecoin price today is  $179.30. This value is interactive so that
