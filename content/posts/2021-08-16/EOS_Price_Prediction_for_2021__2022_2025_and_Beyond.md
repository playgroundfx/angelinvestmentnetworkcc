...
## Weekly Elliott wave EOS analysis as of 16.08.2021

The EOSUSD market is forming the global double zigzag (W)-(X)-(Y). There
has completed the first motive wave (W). The linking wave (X) is
currently unfolding as a double combination W-X-Y. Let us study the
final sub-wave Y currently developing. The Y wave, like W and X, should
be a double zigzag [W]-[X]-[Y]. Let us study the structure of the [W]
wave in more detail in the H8 timeframe.

The [W] wave should be a simple zigzag (A)-(B)-(C). It is clear from the
eight-hour timeframe that the first impulse wave (A) has finished. There
is developing the upward correction (B). In the (B) wave, the leading
diagonal A and correction B have completed. The market should be rising
in the C impulse to a level of 7.50, where wave (B) will be 38.2% of
wave (A). One could enter buy trades in the current situation.
