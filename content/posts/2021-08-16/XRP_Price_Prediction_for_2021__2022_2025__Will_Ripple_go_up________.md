...
## Weekly Elliott wave Ripple analysis as of 16.08.2021

The XRPUSD market continues forming a corrective trend. After the upward
impulse wave A finished, the corrective wave has started unfolding as a
complex structure. There should be unfolding a large double zigzag
[W]-[X]-[Y]. So far, there have completed sub-waves [W]-[X]. The sub-
wave [Y], which has just started, should be unfolding as a double
zigzag. Let us study the chart structure in more detail in a shorter
timeframe.

At the time of writing, the motive sub-wave (W) has completed as a
simple zigzag A-B-C. There is forming the zigzag-shaped linking wave
(X), namely its final sub-wave C. The C wave seems to be a simple
impulse [1]-[2]-[3]-[4]-[5]. The first four parts of the impulse must
have finished, and the price is now rising in the final sub-wave [5].
Sub-wave [5] could end at a level of 1.615, where wave (X) will be 76.4%
of wave (W).
...
The Ripple price today on 17.08.2021 is $1.17627. Looking at the full
