...
## Weekly Elliott wave ZCash analysis as of 16.08.2021

The ZECUSD market is forming an uptrend as a simple zigzag. The upward
impulse wave (A) has finished, and there is unfolding the (B) correction
as a double bearish zigzag W-X-Y. After the linking wave X ended, there
has started the initial part of the descending motive wave Y. The Y wave
could end as a double zigzag [W]-[X]-[Y]. Let us study the most recent
chart section in more detail in the H8 timeframe.

The short-term chart displays the structure of the down motive wave [W]
unfolding as a zigzag (A)-(B)-(C). At the time of writing, the first
sub-wave (A) has finished as a bearish impulse 1-2-3-4-5. The ZEC price
is now rising in the (B) wave, which is about to finish soon. The (B)
looks like a simple zigzag A-B-C, which is expected to complete at a
level of 191.80, where wave (B) will retrace wave (A) by 38.2%. One
could enter buy trades in the current situation.

### Weekly [ZECUSD][8] trading plan:

Buy 153.62, TP 191.80
