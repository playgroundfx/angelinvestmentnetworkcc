...
Bitcoin price today (17.08.2021) is $45 923.93.
...
## Weekly Elliott wave Bitcoin analysis as of 16.08.2021

The BTCUSD market is forming the inceptive part of the long-term bullish
trend. There should be unfolding a simple zigzag. The first sub-wave of
the zigzag, impulse (A), must have completed. After the impulse ended,
the market has turned down and started declining. There should be
forming a descending zigzag [A]-[B]-[C]. So far, there has formed the
first sub-wave of the zigzag, sub-wave [A]. The upward correction [B] is
still developing. Let us study the most recent chart section in more
detail in the H8 chart.

The chart displays the structure of the impulse down wave [A] composed
of the sub-waves (1)-(2)-(3)-(4)-(5). After the [A] impulse completed,
the upward correction [B] has started developing. Wave [B] seems to be a
regular zigzag (A)-(B)-(C). So far, four sub-waves have formed in the
impulse wave (C). The final sub-wave 5 has been half-complete.
Therefore, the Bitcoin price should continue rising in wave 5 towards a
level of 51100.00, where correction [B] will be 61.8% of wave [A].

### Weekly [BTCUSD][1] trading plan:

Buy 47700.46, TP 51100.00
...
If the current price is at $45 923.93, what is the Bitcoin future value?
...
the current Bitcoin price is at $45 923.93. Usually, it’s a better idea
