...
Bitcoin price today (03.08.2021) is $38 877.65.
...
## Weekly Elliott wave Bitcoin analysis as of 02.08.2021

The BTCUSD market is forming the initial part of the long-term zigzag.
The bullish impulse wave (A) seems to have completed. Next, the market
turned down and started declining in the corrective wave. There should
be unfolding the bearish simple zigzag, composed of sub-waves
[A]-[B]-[C]. You can see only the first two legs in the chart now. Let
us study the zigzag in more detail in the H8 chart.

The first sub-wave [A] of the potential zigzag completed as a five-wave
impulse (1)-(2)-(3)-(4)-(5). The corrective wave [B] is a double zigzag
(W)-(X)-(Y). Wave [B] is 38.2% of the [A] impulse. There should be
unfolding the initial part of the bearish impulse wave. The first sub-
wave [1] should end at a level of around 34400.00. Next, the market
could go up a little in the corrective wave [2], as outlined in the
chart. One could enter sell trades in the current situation.

### Weekly [BTCUSD][1] trading plan:

Sell 41683.00, TP 34400.00
...
If the current price is at $38 877.65, what is the Bitcoin future value?
...
the current Bitcoin price is at $38 877.65. Usually, it’s a better idea
