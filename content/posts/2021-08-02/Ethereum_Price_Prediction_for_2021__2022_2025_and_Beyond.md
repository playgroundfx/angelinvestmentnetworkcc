...
## Weekly Elliott wave Ethereum analysis as of ****02.08.2021

The ETHUSD must have completed a multi-year simple zigzag A-B-C. For
more than a year, the Ethereum price has been rising in the upward wave
C, completed as a regular five-wave impulse. It is clear from the most
recent chart section that, after the bullish wave C completed, the
market turned down and started declining. There is likely to be forming
the inceptive part of the new bearish trend. The simple zigzag A-B-C
should be unfolding over the next few weeks. Let us study the most
recent chart section in more detail in a shorter timeframe.

The descending wave A completed as an impulse composed of sub-waves
[1]-[2]-[3]-[4]-[5]. There is unfolding a zigzag-shaped correction B,
which is about to end soon. The B wave could retrace the A wave by 38.2%
and end at a level of 2700.00. Next, after the indicated level is
reached by the price, the market should go down in the first leg of the
new impulse, sub-wave [1], to a level of 2000.00, as outlined in the
chart. One could enter short trades in the current situation.

### Weekly [ETHUSD][2] trading plan:

Sell 2588.27, TP 2000.00
...
ETH is traded at $2 602.18. Below you can see how the price of ETH
