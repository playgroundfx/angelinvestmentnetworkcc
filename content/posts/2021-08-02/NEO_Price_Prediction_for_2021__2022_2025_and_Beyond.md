...
January 2021. The NEO/USD today’s rate is: $43.61
...
## Weekly Elliott wave NEO analysis as of 02.08.2021

The NEOUSD pair is forming the middle part of a large bullish trend,
which is developing as a double zigzag. There is forming the linking
wave (X) as a double zigzag W-X-Y, where the first two parts have been
completed. Wave W is a triple zigzag, linking wave X is a standard
zigzag [A]-[B]-[C].The market is now forming the initial part of the
motive wave Y, which could finish as a double combination. Let us study
the first sub-wave [W] in the H8 timeframe.

The [W] should be forming as a simple zigzag (A)-(B)-(C). The first sub-
wave (A) has completed as an impulse, composed of five sub-waves
1-2-3-4-5. Corrective wave (B), currently unfolding, should end at a
level of 53.00, where the (B) wave will be 23.6% of the (A) impulse.
This ratio is highly likely to be reached. One could enter buy trades in
