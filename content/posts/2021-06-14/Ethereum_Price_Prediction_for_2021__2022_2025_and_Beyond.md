...
## Weekly Elliott wave Ethereum analysis as of 14.06.2021

The [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) timeframe of the ETHUSD price chart displays a zigzag-shaped
pattern A-B-C, which has been developing for more than 4 years. It seems
to have completed. The sub-waves A and C are bullish impulses, wave B is
a correction, completed as a triple zigzag [W]-[X]-[Y]-[X]-[Z].
Therefore, if the assumption is correct, there should be forming an
inceptive part of the new bearish trend. Let us look at the most recent
chart section in the eight-hour timeframe.

After the final impulse wave C of the upward zigzag completed, the
market has turned down and started forming the initial part of the
bearish impulse wave. The first leg, sub-wave 1, may have completed as
an impulse. There is now forming the upward corrective wave 2, which is
likely to be a simple zigzag [A]-[B]-[C]. The sideways corrective wave
[B] should soon end as a double three. Next, the price will continue
rising in the final sub-wave [C]. The bulls may drive the price up to a
level of 2930.00, around which, there earlier completed correction [4],
impulse [A], and the linking wave (X). Therefore, the market, having
reached the high, could turn down and resume declining.

### Weekly [ETHUSD][1] trading plan:

Buy 2353.01, TP 2930.00
...
ETH is traded at $2 560.69. Below you can see how the price of ETH
