...
## Weekly Elliott wave ZCash analysis as of 14.06.2021

The ZECUSD is forming the global corrective trend. A simple zigzag
(A)-(B)-(C) is developing. The first leg of the zigzag, impulse wave
(A), must have completed. There is now forming the bearish correction
(B) as a double zigzag W-X-Y. Wave W is a triple zigzag, linking wave X
is a double zigzag. Wave Y has just started forming as a double zigzag
[W]-[X]-[Y]. Let us explore the chart structure in more detail.

After wave X completed, the price has started declining. There must have
finished the impulse wave (A). The price should be rising in the
corrective wave (B), namely its final sub-wave C. The price could reach
level 209.00. Next, the market will turn down and the price will be
declining. At level 209.00, wave (B) will retrace impulse wave (A) by
38.2%. This ratio is highly likely to be reached. One could enter long
trades with the target at the above-indicated level.

### Weekly [ZECUSD][8] trading plan:

Buy 122.47, TP 209.00
