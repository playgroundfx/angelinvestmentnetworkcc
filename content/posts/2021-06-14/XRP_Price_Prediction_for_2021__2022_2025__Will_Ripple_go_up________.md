...
## Weekly Elliott wave Ripple analysis as of 14.06.2021

It is clear from the [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) XRPUSD price chart that impulse wave A has
completed. Next, the market started declining, forming the corrective
sub-wave. There should be unfolding a large double zigzag [W]-[X]-[Y].
The first motive wave [W] has completed as a triple zigzag. The linking
wave [X] also looks complete, it is composed of the sub-waves
(W)-(X)-(Y). There must be unfolding the final motive wave [Y], it is
not yet visible in the chart, you can see only the inceptive part of it.
Let us study the most recent chart section in the H8 timeframe.

After the linking wave [X] completed, there has started a new zigzag-
shaped pattern. There could be forming a double zigzag (W)-(X)-(Y), with
the first motive wave (W) completed inside. Wave (W) is a regular zigzag
A-B-C. There is developing the linking wave (X) composed of three sub-
waves A-B-C. Wave B, composed of the sub-waves [W]-[X]-[Y] must have
completed. Therefore, the price should be rising in impulse wave C. The
Ripple price should reach level 1.153, where wave (X) will reach the
...
The Ripple price today is $0.88753. Looking at the full price chart
