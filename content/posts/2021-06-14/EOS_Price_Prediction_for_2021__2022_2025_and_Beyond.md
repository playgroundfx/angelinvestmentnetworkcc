...
## Weekly Elliott wave EOS analysis as of 14.06.2021

The EOSUSD market must be forming a global double zigzag (W)-(X)-(Y).
The first motive sub-wave (W) completed, and the linking down wave (X)
is still developing. Wave (X) could complete as a double zigzag W-X-Y.
The first motive wave W and the linking wave X must have completed, both
as double combinations. The final wave Y has just started forming as a
double zigzag [W]-[X]-[Y]. Let us study the first motive wave [W] in the
H8 timeframe.

Wave [W] must be unfolding as a simple zigzag (A)-(B)-(C). The
descending wave (A) has completed as a regular five-wave impulse. Next,
the market has started rising in the corrective wave (B). It seems to be
developing as a simple zigzag A-B-C, where impulse A and correction B, a
double zigzag, have finished. The final wave C has just started
unfolding. The market could go up to a level of 8.18, where wave (B)
will be 38.2% of impulse (A), according to the Fibonacci retracements.
