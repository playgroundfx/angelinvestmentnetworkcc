...
Bitcoin price today (15.06.2021) is $40 118.81.
...
## Weekly Elliott wave Bitcoin analysis as of 14.06.2021

The BTCUSD market should be forming a long-term regular upward zigzag
(A)-(B)-(C). The [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) timeframe displays the first leg of the zigzag,
wave A, namely, its second half. It is a bullish five-wave impulse,
which looks complete. The most recent chart section displays the
inceptive part of the bearish correction. Let us study the chart in more
detail in the eight-hour timeframe.

After the upward impulse (A) had completed, the market turned down and
started declining. There should be unfolding the initial part of the
impulse down wave, which is the first leg of the correction currently
forming. The small sub-waves 1 and 2 have completed as an impulse and a
zigzag; there has also completed the sub-wave of a smaller degree,
impulse [1]. There is developing the corrective wave [2]. the middle
part of the wave [2] seems to be a horizontal correction (B) unfolding
as a double three. The market should continue rising in the (C) impulse
to a level of 44500.00. At this level, wave [2] will reach the 50%
Fibonacci level of wave [1].

### Weekly [BTCUSD][1] trading plan:

Buy 35990.00, TP 44500.00
...
If the current price is at $40 118.81, what is the Bitcoin future value?
...
the current Bitcoin price is at $40 118.81. Usually, it’s a better idea
