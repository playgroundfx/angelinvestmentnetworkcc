...
## Weekly Elliott wave Litecoin analysis as of 14.06.2021

The LTCUSD chart displays a simple zigzag A-B-C, with the bullish wave C
completed inside as a five-wave impulse composed of the sub-waves
[1]-[2]-[3]-[4]-[5]. Therefore, the market should be forming the
inceptive part of the new bearish trend. There must be unfolding a
simple zigzag [A]-[B]-[C]. Let us study the structure of the most recent
chart section in the eight-hour timeframe.

It is clear from the H8 timeframe that the market has completed the down
wave [A] as a five-wave impulse (1)-(2)-(3)-(4)-(5). Next, the price has
started rising in the corrective wave [B]. The corrective wave [B]
should be unfolding as a simple zigzag (A)-(B)-(C), where (B) is a
complex corrective wave developing as a double zigzag W-X-Y. There has
started forming the final upward wave (C). The price could go up to a
level of 230.00. At this level, wave [B] will reach the 38.2% Fibonacci
ratio of wave [A]. This ratio is highly likely to be reached.

### Weekly [LTCUSD][2] trading plan:

Buy 160.81, TP 230.00
...
The Litecoin price today is $174.97. This value is interactive so that
