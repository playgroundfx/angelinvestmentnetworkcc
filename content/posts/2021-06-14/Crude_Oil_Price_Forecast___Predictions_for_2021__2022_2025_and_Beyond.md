...
The oil price for today is $70.914. The chart below is interactive, so
...
## Oil weekly price forecast as of 14.06.2021

Last week, the medium-term oil uptrend continued. As a result, the price
hit another high. The upside target is the Target Zone 3, 73.04 - 72.53.

It is relevant to enter new oil purchases on the correction to the trend
key support zone 65.61 - 65.08. Before you enter purchases, expect the
zone test and find a buy pattern that will provide the entry point.

It is not relevant to sell oil in the medium term.

### [USCrude][6] Trading ideas for the week:

Buy according to the pattern in the Target Zone 65.61 - 65.08.
TakeProfit: 70.78, Target Zone 3, 73.04 - 72.53. StopLoss: according to
the pattern rules.
