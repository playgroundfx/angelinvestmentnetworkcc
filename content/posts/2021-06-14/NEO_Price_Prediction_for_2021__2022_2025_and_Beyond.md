...
January 2021. The NEO/USD today’s rate is: $50.19
...
## Weekly Elliott wave NEO analysis as of 14.06.2021

The NEOUSD market, like in the previous weeks, continues forming the
global upward double zigzag (W)-(X)-(Y). The upward motive wave (W) has
ended. There is unfolding the final motive wave in the linking wave (X).
Wave (X) is developing as a double zigzag W-X-Y. Wave W is a triple
zigzag, wave X is a standard zigzag. Wave Y must be a double zigzag
[W]-[X]-[Y]. Let us study the first motive wave [W] in more detail in a
shorter timeframe.

Wave [W] should finish as a simple zigzag (A)-(B)-(C). The first impulse
wave (A) must have completed, and there is unfolding the upward
correction (B). The market should be soon rising in the impulse wave C
to a level of 75.20, as the first impulse wave A and the correction B,
which is a double zigzag, look complete. At level 75.20, wave (B) will
reach the 38.2% Fibonacci level of wave (A). Next, the price will start
declining in wave (C). One could enter purchases in the current
situation.
