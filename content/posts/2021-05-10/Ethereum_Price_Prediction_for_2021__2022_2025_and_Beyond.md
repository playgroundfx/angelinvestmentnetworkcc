...
## Weekly Elliott wave Ethereum analysis as of 10.05.2021

Like in the previous trading weeks, the ETHUSD market is developing the
final impulse wave C, which is the final leg of the standard bullish
zigzag A-B-C. The C impulse is composed of five sub-waves
[1]-[2]-[3]-[4]-[5]. There is currently unfolding the final sub-wave [5]
as an impulse (1)-(2)-(3)-(4)-(5). Let us see its structure in more
detail in the eight-hour timeframe.

Sub-waves (1)-(2)-(3)-(4) have completed. Waves (1) and (3) are simple
impulses, wave (2) is a zigzag-shaped correction. Correction (4) is a
double three W-X-Y. There is now unfolding the impulse upwave (5), with
the first four legs completed inside. The Ethereum price should be
rising in the final sub-wave 5 to a level of 4200.00. Next, the market
will turn down and start declining.

### Weekly [ETHUSD][1] trading plan:

Buy 3915.77, TP 4200.00
...
ETH is traded at $3 942.17. Below you can see how the price of ETH
