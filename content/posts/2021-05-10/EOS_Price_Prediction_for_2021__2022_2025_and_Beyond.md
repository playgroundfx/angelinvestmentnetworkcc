...
## Weekly Elliott wave EOS analysis as of 10.05.2021

The EOSUSD market is forming the simple global zigzag [A]-[B]-[C]. The
first impulse wave [A] completed, and the descending corrective wave [B]
is still unfolding. Wave [B] may complete as a double zigzag W-X-Y. The
first motive wave W is also a double zigzag, and the linking wave X
should have a similar structure. Let us explore the structure of the
linking wave X in the H8 timeframe.

Wave X is composed of three sub-waves [W]-[X]-[Y]. In late December
2020, the market finished forming the middle leg of the zigzag, the
linking wave [X]. Next, the market started rising. The final motive wave
[Y] should be unfolding as a simple zigzag. Impulse wave (A) and
corrective wave (B) have completed, and the (C) impulse is still
unfolding. It is likely to complete at a level of around 14.79, as
outlined in the chart. At this level, wave X will retrace the W wave by
61.8%.
