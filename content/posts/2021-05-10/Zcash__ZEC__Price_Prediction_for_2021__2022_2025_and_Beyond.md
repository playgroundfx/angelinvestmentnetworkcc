...
## Weekly Elliott wave ZCash analysis as of 10.05.2021

The ZECUSD is forming the global corrective trend. There is forming a
simple zigzag A-B-C, with the sub-waves A and B, completed inside. Since
March 2020, the market has been forming the beginning of impulse wave C.
So far, there have completed two small sub-waves [1] and [2]. Let us
study the structure of the most recent chart section in more detail in
the eight-hour timeframe.

In the most recent chart section, there have completed a number of first
and second sub-waves of different wave degrees. There is currently
unfolding the bullish impulse wave (3), with impulse 1 and zigzag-shaped
correction 2 completed inside. During the second half of April, the
price was rising in the upward impulse [1] of a smaller degree. It seems
to have completed, so the price should be declining in correction [2].
Correction [2] should end at a level of 210.00, where wave [2] will
retrace wave [1] by 76.4%.

### Weekly [ZECUSD][8] trading plan structure:

Sell 301.31, TP 210.00
