...
The current rate of the EUR/USD pair is $1.17263. Below, you can see an
...
## Euro/dollar weekly price forecast as of 20.09.2021

Last week, the euro-dollar medium-term downtrend continued, and the
price reached Target Zone 1.1733 – 1.1715, which serves as the strong
support. The price will continue falling if bears break out level
1.1715. If so, it will be relevant to sell down to level 1.1667.

If Target Zone 1.1733 – 1.1715 is not broken out, the price could rise
to a level of 1.1905. In this case, one could trade counter the trend
and buy the euro according to the pattern.

### [EURUSD][1] Trading ideas for the week:

Buy according to the pattern in Target Zone 1.1733 - 1.1715. TakeProfit:
1.1905. StopLoss: according to the pattern rules.
