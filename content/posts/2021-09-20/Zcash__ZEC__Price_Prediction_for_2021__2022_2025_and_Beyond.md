...
## Weekly Elliott wave ZCash analysis as of 20.09.2021

The ZECUSD market continues forming the corrective down wave (B) as a
double zigzag W-X-Y. The first two legs, sub-waves W-X, have finished
within the zigzag, and there is unfolding the final sub-wave Y as a
double zigzag [W]-[X]-[Y], as outlined in the chart. Let us explore the
...
completed as a five-wave impulse. The (B) correction is an upward three-
wave zigzag. There is forming the beginning of the bearish wave (C),
which should be an impulse. The potential impulse wave (C) could drive
the price to a level below 82.71, marked by the (A) wave.

### Weekly [ZECUSD][8] trading plan:

Sell 139.10, TP 82.71
