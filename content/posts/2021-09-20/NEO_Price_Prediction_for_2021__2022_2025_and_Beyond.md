...
January 2021. The NEO/USD today’s rate is: $41.95
...
## Weekly Elliott wave NEO analysis as of 20.09.2021

The [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) timeframe of the NEOUSD chart displays the structure of the
linking wave (X) unfolding as a double zigzag. Within this zigzag, there
have completed the motive wave W, a triple zigzag, and the linking wave
X, a simple zigzag. After the linking wave X completed, the market has
started declining in the initial part of the final sub-waves Y. The Y
wave should be a double zigzag [W]-[X]-[Y]. Let us study the first
motive sub-wave [W] in the eight-hour timeframe.

The down wave [W] looks like a simple zigzag (A)-(B)-(C). The upward
corrective wave (B) seems to have completed as a zigzag A-B-C. The
market is declining, as the final impulse wave (C) must have started.
The NEO price should be going down to a level below 32.20, marked by a
short correction [2]. One could enter sell trades in the current
situation. The target will be level 32.20.
