...
## Weekly Elliott wave Litecoin analysis as of 20.09.2021

The [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) timeframe of the LTCUSD chart displays a simple three-wave
zigzag A-B-C, completed in early summer. After the upward impulse wave C
finished, the market has started declining in the new bearish trend.
There should be forming a descending zigzag [A]-[B]-[C]. The first two
parts of this pattern, impulse [A] and correction [B], look complete.
...
(1)-(2)-(3)-(4)-(5). After the [A] finished, there has formed correction
[B] as a simple zigzag composed of sub-waves (A)-(B)-(C). The most
recent chart section displays the final sub-wave of the forming zigzag,
which could be an impulse. The Litecoin price should go down to a level
of 135.50 and lower.

### Weekly [LTCUSD][3] trading plan:

Sell 180.53, TP 135.50
...
The Litecoin price today is  $158.82. This value is interactive so that
