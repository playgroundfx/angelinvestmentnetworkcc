...
Bitcoin price today (21.09.2021) is $43 679.95.
...
## Weekly Elliott wave Bitcoin analysis as of 20.09.2021

The BTCUSD market is forming the initial wave of the long-term bullish
zigzag. Its first sub-wave, a five-wave impulse (A) completed. Next, the
market turned down and started moving down. There should be forming a
simple descending zigzag [A]-[B]-[C]. The first two parts of the zigzag
must have completed. Therefore, the final, third, leg should be
unfolding. Let us study the market situation in more detail in the
eight-hour timeframe.

The most recent chart section displays the market downward movement in
the impulse wave [A], which is complete. The [A] is composed of five
sub-waves (1)-(2)-(3)-(4)-(5). Next, the [B] correction has completed as
a zigzag (A)-(B)-(C). The market should be moving down in the final
impulse wave. The first target for sell trades is at a level of
37500.00, the low marked by corrective wave (B).

### Weekly [BTCUSD][1] trading plan:

Sell 48052.00, TP 37500.00
...
If the current price is at $43 679.95, what is the Bitcoin future value?
...
the current Bitcoin price is at $43 679.95. Usually, it’s a better idea
