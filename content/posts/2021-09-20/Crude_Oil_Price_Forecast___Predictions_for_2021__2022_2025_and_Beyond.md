...
## Oil weekly price forecast as of 20.09.2021

Last week, the oil price closed under the strong medium-term resistance,
Target Zone 2, 73.16 – 72.62. However, the medium-term uptrend
continues, and it is relevant to enter buy trades. One could enter a
long when a correction starts, for example, towards the trend key
support 67.77 – 67.26. Next, we shall monitor the buyers’ reaction and
open a position according to the pattern. The upside target will be
around the high of last week.

An alternative scenario suggests the breakout of Target Zone 2 and
consolidation above. If so, level 73.80 will be the support where one
could enter a long trade with a target in Target Zone 3, 78.45 – 77.92.

### [USCrude][12] Trading ideas for the week:

Buy according to the pattern in Target Zone 67.77 - 67.26. TakeProfit:
72.62. StopLoss: according to the pattern rules.
