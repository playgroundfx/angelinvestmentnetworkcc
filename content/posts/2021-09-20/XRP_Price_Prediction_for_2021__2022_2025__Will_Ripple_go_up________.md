...
## Weekly Elliott wave Ripple analysis as of 20.09.2021

The XRPUSD [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) chart displays the middle element of the large simple
zigzag A-B-C. The upward impulse wave A finished. Next, there has
started a deep correction B unfolding as a double zigzag [W]-[X]-[Y],
where the first two parts have completed. The motive wave [W] is a
triple zigzag (W)-(X)-(Y)-(XX)-(Z). The linking wave [X] has completed
as a double zigzag (W)-(X)-(Y). The final motive wave [Y] should be a
double zigzag. Let us study the chart structure in more detail in the
eight-hour timeframe.

So far, there have completed two sub-waves (W) and (X) of the bearish
zigzag. Each sub-wave is a simple zigzag. Therefore, there is developing
the initial part of the new descending motive wave of the double zigzag.
The Ripple price should go down to a level of 0.687, where a short
correction [4] completed. One could enter short trades in the current
situation.
...
The Ripple price today on 21.09.2021 is $0.92852. Looking at the full
