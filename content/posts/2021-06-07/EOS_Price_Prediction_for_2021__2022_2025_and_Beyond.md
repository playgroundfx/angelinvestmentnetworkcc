...
## Weekly Elliott wave EOS analysis as of 07.06.2021

The EOSUSD is probably building a global double zigzag (W)-(X)-(Y). The
first actionary sub-wave (W) was fully completed, and a downward linking
wave (X) is still unfolding. Wave (X) may form as a double zigzag W-X-Y.
The first actionary wave W and a linking wave X are double zigzags and
seem to have formed fully. The ultimate wave Y has just started
developing. Most likely, it will form as a double zigzag [W]-[X]-[Y]
too. Let’s examine wave Y in detail on the H8 timeframe.
