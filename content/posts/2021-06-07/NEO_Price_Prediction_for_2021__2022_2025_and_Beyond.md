...
January 2021. The NEO/USD today’s rate is: $52.90
...
## Weekly Elliott wave NEO analysis as of 07.06.2021

The NEOUSD continues moving within an ascending double zigzag
(W)-(X)-(Y), just as it did in the last trading weeks. An ascending
actionary wave (W) is complete, and we can see its ultimate part on the
[daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) timeframe. The first part of the ultimate actionary wave in
linking wave (X) is developing at the moment. Wave (X) is forming as
double zigzag W-X-Y. Wave W is a triple zigzag, and wave X is a simple
zigzag. Wave Y will most likely develop as double zigzag [W]-[X]-[Y].
Let’s have a detailed look at the last segment of the chart on the H8
timeframe.

A descending wave [W] continues forming in the last segment of the
chart. It will most likely develop as a simple zigzag (A)-(B)-(C). The
first impulse wave (A) may have already ended, and an ascending
correction (B) is unfolding at the moment. There may occur impulse
growth in wave C to 77.80 in the near time. At that level, the size of
wave (B) will be 38.2% of wave (A) based on the Fibo ratios. The price
will then decline in wave (C). In that scenario, long positions can be
considered.

### Weekly [NEOUSD][2] trading plan structure:
