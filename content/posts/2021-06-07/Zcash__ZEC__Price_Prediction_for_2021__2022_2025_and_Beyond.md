...
## Weekly Elliott wave ZCash analysis as of 07.06.2021

The ZECUSD cryptocurrency pair is following a global corrective trend at
the moment. There's a simple zigzag (A)-(B)-(C) forming. Most probably,
its first part — impulse wave (A) — has fully formed. A bearish
correction (B), which may form as a double zigzag W-X-Y, is developing
at the moment. Wave W is a triple zigzag, and linking wave X is a double
...
The price started moving down after wave X formed. Most probably,
impulse wave (A) is complete. The price may correct and rise in the
ultimate sub-wave C of wave (B) in the near time. It may reach the level
of 209.00, reverse and resume falling. Wave (B) will be 38.2% of impulse
