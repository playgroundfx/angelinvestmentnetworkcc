...
Bitcoin price today (08.06.2021) is $34 434.07.
...
## Weekly Elliott wave Bitcoin analysis as of 07.06.2021

Bitcoin is in a big long-term uptrend and may form a simple zigzag
(A)-(B)-(C). The first impulse wave (A) might have been fully completed.
It consists of sub-waves 1-2-3-4-5. The first part of a corrective
bearish wave is forming at the moment. Its first part may unfold as a
descending impulse 1-2-3-4-5. Only sub-waves 1 and 2, which we can see
in the chart, have been formed by now. Let’s look at the last segment of
the chart on the H8 timeframe.

The market started forming the third wave's first part after a bearish
wave 1 and a zigzag-shaped corrective wave 2 were formed. A descending
wave [1] appears to have formed as an impulse. The second part of an
ascending correction [2], which may form as a simple zigzag (A)-(B)-(C),
is unfolding at the moment. Correction (B) is triangle A-B-C-D-E,
apparently. It may end in the near time.Then the market may grow in an
impulse wave (C) that may end wave [2]'s development at 44,500.00. Its
size will be 50% of wave [1] at that level.

### Weekly [BTCUSD][1] trading plan structure:

Buy 36376.00, TP 44500.00
...
If the current price is at $34 434.07, what is the Bitcoin future value?
...
the current Bitcoin price is at $34 434.07. Usually, it’s a better idea
