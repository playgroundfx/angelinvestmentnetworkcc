...
Bitcoin price today (30.10.2021) is $62 435.08.
...
## Weekly Elliott wave Bitcoin analysis as of 29.10.2021

The BTCUSD market is forming the new bearish corrective trend that has
started after the multi-year bullish impulse (A) finished. There should
be unfolding a simple zigzag, with impulse sub-wave [A] composed of sub-
waves (1)-(2)-(3)-(4)-(5) completed inside. The bullish correction [B]
is currently unfolding. Let us explore this correction in more detail in
a shorter timeframe.

The corrective upwave [B] is unfolding as a simple zigzag (A)-(B)-(C).
Sub-wave (A) is a bullish impulse. The down corrective wave (B) is a
simple zigzag A-B-C. Sub-wave (C) is a simple five-wave impulse
currently developing. Sub-waves 1-2-3-4 have completed in the (C) wave.
The price should be rising in the final sub-wave 5 to the level of
67200.00, where impulse sub-wave 3 finished.

### Weekly[ BTCUSD][1] trading plan:

Buy 61259.00, TP 67200.00
...
If the current price is at $62 435.08, what is the Bitcoin future value?
...
the current Bitcoin price is at $62 435.08. Usually, it’s a better idea
