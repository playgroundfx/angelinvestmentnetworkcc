...
## Weekly Elliott wave Ethereum analysis as of 29.10.2021

The ETHUSD price chart displays the structure of the global simple
zigzag composed of three major sub-waves A-B-C. This zigzag looks
complete. There is developing the inceptive part of the new bearish
trend, which is likely to be a zigzag. The first impulse sub-wave A has
completed so far. The corrective upwave is currently developing. Let us
study its structure in more detail in the eight-hour timeframe.

It is clear from the eight-hour timeframe that the upward correction B
is a simple zigzag [A]-[B]-[C]. Sub-wave [A] is an impulse
(1)-(2)-(3)-(4)-(5), where correction (4) is a contracting triangle.
Sub-wave [B] is a correction completed as a simple zigzag (A)-(B)-(C).
The impulse wave [C] is currently developing. The Ethereum price should
be rising in the final fifth sub-wave to a level of 4550.00. Next, the
market could turn down and start declining.

### Weekly[ ETHUSD][2] trading plan:

Buy 4343.99, TP 4550.00
...
ETH is traded at $4 409.62. Below you can see how the price of ETH
