...
## Weekly Elliott wave Ripple analysis as of 29.10.2021

The [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) XRPUSD chart displays the structure of the corrective trend
unfolding as a simple zigzag. There is now developing the middle leg of
the zigzag, corrective wave B, unfolding as a double zigzag [W]-[X]-[Y].
This year, the final motive wave [Y] has been unfolding as a double
zigzag (W)-(X)-(Y). It has been half-complete so far. Let us explore the
initial part of the final sub-wave (Y), which could end as a triple
zigzag W-X-Y-XX-Z in a shorter timeframe.

The eight-hour timeframe displays the initial part of the potential
triple zigzag. The bearish motive wave W, composed of sub-waves
[A]-[B]-[C], must have completed. The linking upwave X is currently
unfolding as a triple zigzag [W]-[X]-[Y]-[X]-[Z]. The Ripple price
should be rising in the zigzag (A)-(B)-(C) which could end the final
sub-wave [Z] near the level of 1.218. It is the previous high, marked by
wave [Y].
...
The Ripple price today on 30.10.2021 is $1.08200. Looking at the full
