...
The current rate of the EUR/USD pair is $1.15900. Below, you can see an
...
## Euro/dollar weekly price forecast as of 08.11.2021

The euro-dollar downtrend continued last week. The price broke through
the October low and reached the support level of 1.1527. The support at
1.1527 hasn’t yet been broken out by the price. The price will continue
falling if it breaks out the support and consolidates below. In this
case, the new downside target will be Target Zone 5, 1.1386 – 1.1368. It
will be relevant to enter new shorts at the mirror levels of 1.1562 -
1.1527.

If the price doesn’t break out the support at 1.1527, there will be
another correction up with a target in the trend key resistance zone
1.1707 – 1.1689. In this case, one could enter a purchase according to a
buy pattern.

### [EURUSD][1] Trading ideas for the week:

  1. Aggressive: buy according to the pattern at level 1.1527. TakeProfit: 1.1707 - 1.1689. StopLoss: according to the pattern rules.
  2. If the price breaks out the zone of 1.1562 - 1.1527 and consolidates below, sell on the retest. TakeProfit: Target Zone 5, 1.1386 - 1.1368. StopLoss: 1.1595.
