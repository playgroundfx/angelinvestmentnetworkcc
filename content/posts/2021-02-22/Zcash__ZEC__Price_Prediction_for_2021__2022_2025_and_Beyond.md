...
Although the cryptocurrency started 2020 at $27 and is finishing up the
year at around $70, the price was highly volatile during the last 12
months. As we are interested in longer-term investing, let's consider
the weekly chart of the [ZEC/US dollar][1] pair on the Gemini
[cryptocurrency exchange](https://www.playgroundfx.com/blog/best-cryptocurrency-exchange/). As you can see, the price has formed a
symmetrical triangle. It means that there are equal chances of an upward
and downward movement.

Look at the prediction chart below.

The uptrend will be confirmed if only ZEC closes above $80. Then, a
Zcash projected growth is around $100. If bulls are strong enough, the
pair will move to $125 and higher.

Still, if bears are stronger and supported by negative factors, the
ZEC/USD pair will fall below the bottom line of the triangle pattern, a
close below $49 will signal a decline to $25.

## Weekly Elliott wave ZCash analysis as of 22.02.2021

The ZECUSD market is forming the global simple zigzag A-B-C. In early
2020, the deep corrective wave B completed as a triple zigzag. The
motive sub-waves (W), (Y) and (Z) are simple zigzags composed of the
sub-waves (A)-(B)-(C). After that, the initial leg of the upward impulse
wave C has started forming. Let us explore the most recent chart section
in more detail in the eight-hour timeframe.

The sub-waves [1] and [2] have completed; they are an impulse and a
double zigzag, respectively. At the time of writing, the market must
have finished the upward sub-wave (1), which should be an impulse.
Therefore, the price should be declining in correction (2), which could
end at a level of around 101.70, where wave (2) will be 61.8% of the
impulse wave (1) according to the Fibonacci retracements. One could
enter short positions in the current situation.

### Weekly [ZECUSD][8] trading plan:

Sell 152.03, TP 101.70
...
If you don't try trading on [demo account][9] before entering the real
...
( {{count}} {{title}} )
   ...
   9. my.liteforex.com/trading/chart?symbol=ZECUSD&returnUrl=true
   10. my.liteforex.com/trading/?category=analysts-opinions&slug=zcash-price-prediction-forecast&type=currency