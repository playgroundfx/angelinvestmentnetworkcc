...
The price for today is $61.538. The chart below is interactive, so you
...
## Oil weekly price forecast as of 22.02.2021

The oil price didn’t consolidate above Target Zone 5 [59.82 – 59.31]
last week. Instead of the consolidation, there appeared a false breakout
pattern to sell. This pattern suggests one could trade in the
correction.

On Friday, February 19, there was a sell entry at level 59.80. The sell
target is the trend key support [57.71 — 57.26].

This week, there should be developing a correction; the price is likely
to test the support level [57.71 – 57.26]. If the price doesn’t break
out the zone and draws a buy pattern, one could consider entering long
positions in the trend with a target at February’s high.

If level 57.62 is broken out downside, the medium-term oil trend will
turn down. If so, it will be relevant to sell oil with the target at
Target Zone 2 [53.19 — 52.73].

### [USCrude][3] Trading ideas for the week:

  1. Hold sell trades entered at level 59.80. TakeProfit: 57.62. StopLoss: 60.85.
  2. If level 57.62 is broken out, sell. TakeProfit: Target Zone 2 [53.19 - 52.73]. StopLoss: 58.87.
  3. If level 57.62 is held up, buy according to the pattern. TakeProfit: 62.18. StopLoss: according to the pattern rules.
