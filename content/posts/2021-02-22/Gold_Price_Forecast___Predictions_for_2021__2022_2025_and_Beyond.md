...
Gold Price Forecast & Predictions: 2021 and BeyondJana Kane
...
Source: Goldprice.org, the screenshot was taken on December 20, 2020

We can assert that these forecasts were more than justified, for
instance, on Friday, December 18, 2020, the gold price closed at
1,881.26 USD per ounce.



**The current price of gold is $1 808.20.**
...
As of December 18, 2020 (midday), the gold price shows some new negative
trades to retest its previous 1875.00 level. As long as the price stays
above this level, a bullish impression shall remain in force for the
coming days, supported by statistically distributed reach to the
oversold areas, besides the EMA50 that continues to carry the price from
below, reminding us that our next targets begin at 1917.00 and extend to
1928.60. The expected gold trading range based on these indicators is
currently between 1860.00 support and 1910.00 resistance.

 _Source: economies.com, the screenshot was taken on December 20, 2020_

## Gold weekly price forecast as of 22.02.2021

Last week, gold bears achieved all sell targets. The price broke through
the low of February 4 and reached Target Zone 2 [1760 — 1750].

However, the medium-term trend continues. The price is now being
corrected up. One of the possible correction targets is Intermediary
Zone [1821 – 1815]. If the gold price reaches the resistance, it will be
relevant to look for sell entries according to the pattern. The target
will be the low of last week.

The second likely scenario suggests the price should continue falling
and break out TZ2. If so, one could enter short positions with the
target at Target Zone 3 [1659 — 1649].

[][13]

### [XAUUSD][14] Trading ideas for the week:

Sell in Intermediary Zone [1821 - 1815]. TakeProfit: 1760. StopLoss:
1841.1.

 _Technical analysis based on margin zones methodology was provided by
an independent analyst,_[ __][15][ _Alex Rodionov_][15] _._
...
*Please note that long-term price forecasts for any investment asset are very approximate and may change due to various factors. Keep reading to find out which factors may [affect the price of gold][15].
...
jewelry and investment instruments.
...
Make sure to create a free demo account on [LiteForex][16]! On
 ...
 ** _Disclaimer: When deciding on the execution of any transaction in
the currency and gold markets, you should be aware of the high
volatility (volatility) of prices in these markets. Late and emotional
decisions to buy and sell any goods and assets, including gold and
currencies, can lead to financial losses. Any information on this
[website](https://www.playgroundfx.com/blog/website-for-forex-trading/) is for informational purposes only and does not constitute an
offer to conduct transactions._**
...
( {{count}} {{title}} )
   ...
   13. cdn.liteforex.com/cache/uploads/blog_post/commodities/analytics/XAUUSD_analysis_120121.png?q=75&s=e4b1a8b482b4f51d360fdf50c263c4a3
   14. my.liteforex.com/trading/chart?symbol=XAUUSD&returnUrl=true
