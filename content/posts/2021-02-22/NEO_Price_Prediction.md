...
## Weekly Elliott wave NEO analysis as of 22.02.2021

The NEOUSD market must be forming a simple upward zigzag A-B-C, which
has been unfolding for more than three years. The impulse wave A has
completed, as well as the corrective wave B, which is a triple zigzag.
There is now unfolding the initial part of the impulse wave C. The first
small sub-waves [1] and [2] look complete, and there is now forming wave
[3]. Let us study the latest chart section in more detail in a shorter
timeframe.

In late December 2020, the corrective down wave [2] completed as a
double zigzag (W)-(X)-(Y). Next, the market has started rising. There
should be forming the initial part of the upward impulse. The impulse
wave (1) could have completed. If the assumption is correct, the NEO
price should soon start declining in the corrective wave (2), which
could end as a standard zigzag A-B-C. This zigzag should end at a level
of 28.60, where wave (2) will reach the Fibonacci ratio of 61.8% of wave
(1). This ratio is highly likely to be reached.
...
this means that you will receive [approximately 1 GAS per month][8] for
...
relatively low compared to the [all-time][9] high ($97.49 USD on Jan 15,
...
For example, a NEO prediction has been made on [Coinswitch][10] for the
...
( {{count}} {{title}} )
   ...
   8. neotogas.com/#:~:text=How%20to%20earn%20GAS%3F,not%20on%20the%20Exchange%20anymore.
   9. [Coinmarketcap](https://www.playgroundfx.com/blog/coinmarketcap-creator/).com/currencies/gas/
   10. coinswitch.co/[news](https://www.letsplayfx.com/blog/forex-news-website/)/neo-price-prediction-2019-neo-price-to-touch-200-usd-by-2019-latest-neo-price-update
   11. www.liteforex.com
   12. my.liteforex.com/trading/?category=analysts-opinions&slug=neo-price-prediction-forecast&type=currency