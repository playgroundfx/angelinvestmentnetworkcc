...
## Weekly Elliott wave Litecoin analysis as of 06.09.2021

The LTCUSD market has completed the zigzag-shaped pattern A-B-C. The
price is now declining in the new downtrend. There should be unfolding
the initial part of the simple zigzag. The first impulse wave [A],
composed of sub-waves (1)-(2)-(3)-(4)-(5), looks complete. The
corrective wave [B] also looks complete. Let us study the most recent
chart section in more detail in the eight-hour timeframe.

The upward corrective wave [B] is a simple zigzag (A)-(B)-(C). The
market has already reached level 221.00, where wave [B] retraced wave
[A] by 38.2%. Therefore, the market should turn down soon and start
declining in the new down wave. The first target for sell trades is
level 165.50, the previous low marked by correction 4.

### Weekly [LTCUSD][3] trading plan:

Sell 215.20, TP 165.50
...
The Litecoin price today is  $222.83. This value is interactive so that
