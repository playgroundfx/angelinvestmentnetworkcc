...
Bitcoin price today (07.09.2021) is $51 917.50.
...
## Weekly Elliott wave Bitcoin analysis as of 06.09.2021

The BTCUSD market has completed the upward wave (A) as a five-wave
impulse. Next, there has started the new corrective wave unfolding as a
simple zigzag, with sub-wave [A] completed inside. The corrective wave
[B] also looks complete, because the market has reached level 51100.00,
as expected. Let us study the market situation in more detail in the
eight-hour timeframe.

It is clear from the H8 BTCUSD price chart that the market started
forming the upward corrective wave [B] after the impulse wave [A] had
finished. The [B] correction, composed of sub-waves (A)-(B)-(C), seems
to have completed. Wave [B] is 61.8% of wave [A], according to the
Fibonacci retracements. Therefore, the Bitcoin price should be declining
in the new bearish wave to a level below the low of 37500.00, marked by
the (B) wave. One could enter sell trades in the current situation.

### Weekly [BTCUSD][1] trading plan:

Sell 49918.25, TP 37500.00
...
If the current price is at $51 917.50, what is the Bitcoin future value?
...
the current Bitcoin price is at $51 917.50. Usually, it’s a better idea
