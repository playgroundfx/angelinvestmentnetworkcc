...
## Oil weekly price forecast as of 06.09.2021

The oil trend has turned up. The price consolidated above the Target
Zone 67.71 – 67.17. The next upside target is Target Zone 2, 73.16 –
72.62.

This week, it is relevant to enter oil buy trades on the correction down
to the strong support level. Strong support levels are now level 67.17
and Target Zone 64.97 – 64.43. Enter a trade according to the pattern.
The first take-profit could be set at the high of last week.

The above scenario to buy will be cancelled if the price breaks out the
trend key support 64.97 – 64.43.

### [USCrude][12] Trading ideas for the week:

  1. Buy according to the pattern at level 67.17. TakeProfit: 70.13. StopLoss: according to the pattern rules.

  2. Buy according to the pattern in Target Zone 64.97 - 64.43. TakeProfit: 70.13. StopLoss: according to the pattern rules.
