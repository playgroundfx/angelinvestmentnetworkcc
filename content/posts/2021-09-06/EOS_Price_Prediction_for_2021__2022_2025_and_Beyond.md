...
## Weekly Elliott wave EOS analysis as of 06.09.2021

The EOSUSD market continues forming the middle leg of the global double
zigzag, this is the linking wave (X). The descending wave (X) is likely
to end as a double combination  W-X-Y. Sub-waves W and X have completed
as double zigzags. And the final motive wave Y has just started. Let us
explore the structure of the first bearish wave [W] in the H8 timeframe.

It is clear from the most recent chart section that the market is
forming a simple descending zigzag. So far, the down wave (A) has
completed as an impulse 1-2-3-4-5. There is forming the bullish
correction (B) as a simple zigzag, which should soon finish. There
should be unfolding the final, fifth, leg of the impulse upwave C, which
could conclude the entire correction (B) at a level of 7.50.  At this
