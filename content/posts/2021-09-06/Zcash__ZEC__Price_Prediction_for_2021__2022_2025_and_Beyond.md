...
## Weekly Elliott wave ZCash analysis as of 06.09.2021

It is clear from the [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) ZECUSD timeframe that the market is forming
the long-term corrective trend as a simple zigzag (A)-(B)-(C). The first
impulse wave (A) must have completed, and there is developing the
corrective wave (B). It has a complex structure, unfolding as a double
zigzag W-X-Y, where the first motive wave W is a triple zigzag. The
final motive wave Y, which has recently started forming, could finish as
a double combination, like the linking wave X. Let us explore the
structure of the first down sub-wave [W] in the H8 timeframe.

The [W] wave should have a simple structure of a zigzag composed of sub-
waves (A)-(B)-(C). It is clear from the chart that the down wave (A) has
completed as an impulse. The (B) correction is currently unfolding as a
simple zigzag A-B-C, which should end at a level of 191.80, where wave
(B) will retrace wave (A) by 38.2%. This ratio is highly likely to be
reached. One could enter purchases in the current situation.

### Weekly [ZECUSD][8] trading plan:

Buy 156.57, TP 191.80
