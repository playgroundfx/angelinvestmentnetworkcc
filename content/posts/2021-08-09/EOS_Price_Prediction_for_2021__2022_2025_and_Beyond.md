...
## Weekly Elliott wave EOS analysis as of 09.08.2021

The EOSUSD is building a big double zigzag (W)-(X)-(Y) in the long term.
The first part of the pattern, sub-wave (W), is fully completed. Linking
wave (X), which may unfold as a double combination W-X-Y, is developing
at the moment. Let's check out the ultimate sub-wave Y, which is forming
at the moment. Most likely, it will form as a double zigzag [W]-[X]-[Y]
too, as sub-waves W and X did. Let’s have a detailed look at its first
part on the H8 chart.

We saw in the [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) chart that the first sub-wave of a new bearish
double zigzag, sub-wave [W], is forming. It will most likely be simple
and develop as zigzag (A)-(B)-(C). The first impulse wave (A) looks
fully completed on the H8 chart. The downward correction (B) is forming
at the moment. As its part, there formed a leading diagonal A and
correction B. The market is likely to rise in impulse C to 5.77 in the
near time. At that price level, the size of wave (B) will be 23.6% of
wave (A). The probability of reaching that ratio is high.
