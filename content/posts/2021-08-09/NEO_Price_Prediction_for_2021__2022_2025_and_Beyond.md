...
January 2021. The NEO/USD today’s rate is: $45.67
...
## Weekly Elliott wave NEO analysis as of 09.08.2021

The NEOUSD pair's current pattern is structured in a way that implies
the formation of a double zigzag, with the first motive wave completed
as part of it. Linking wave (X) is unfolding at the moment. It will most
likely form as a double zigzag W-X-Y, where sub-wave Y, which is
currently missing, started forming not long ago. Its projected future
structure is outlined in the chart. Let’s have a look at a projected
wave [W] on the H8 chart.

Most likely, wave [W] will form as a simple zigzag (A)-(B)-(C). Upon
completion of the bearish impulse wave (A), the market started moving up
in the correction (B), which is supposed to end at around 69.40, forming
a zigzag A-B-C. At that level, the size of wave (B) will be 38.2% of
wave (A). So, we can open long positions to make profits at that level.
