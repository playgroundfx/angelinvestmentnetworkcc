...
## Weekly Elliott wave Litecoin analysis as of 09.08.2021

The market finished forming a large zigzag-shaped pattern in LTCUSD,
zigzag A-B-C. So, the pair is following a new downtrend in the last
segment of the chart. A new zigzag consisting of sub-waves [A]-[B]-[C]
might have started to develop. Only the first part, sub-wave [A], has
been completed for now. Let’s examine that segment in detail on the H8
chart.

The downward wave [A] is a simple 5-wave impulse (1)-(2)-(3)-(4)-(5).
Its corrective wave (4) is a skewed triangle A-B-C-D-E. The upward
correction [B], which may form as a zigzag (A)-(B)-(C), is unfolding at
the moment. Sub-wave (C), which is missing for it to be fully completed,
may form as an impulse or an ending diagonal. It is expected to unfold
to about 221.00. At that level, the size of wave [B] will equal 38.2% of
wave [A].

### Weekly [LTCUSD][3] trading plan:

Buy 156.49, TP 221.00
...
The Litecoin price today is  $164.41. This value is interactive so that
