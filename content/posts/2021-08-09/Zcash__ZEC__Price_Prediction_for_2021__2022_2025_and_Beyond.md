...
## Weekly Elliott wave ZCash analysis as of 09.08.2021

There's an uptrend looking like a simple zigzag on the [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) chart of
the ZECUSD cryptocurrency pair. An ascending impulse wave (A) was
completed, and a long corrective wave (B) developed afterwards. That
correction is developing as a bearish double zigzag W-X-Y. The ascending
linking wave X might have formed in spring, and the market then started
building the first part of the descending actionary wave Y. Most likely,
wave Y will form as a double zigzag [W]-[X]-[Y]. Let’s have a detailed
look at its first part on the H8 chart.

The descending actionary wave [W] is forming in the last segment of the
chart. That wave may develop as a zigzag (A)-(B)-(C). Only the first
sub-wave (A) has fully formed as a bearish impulse 1-2-3-4-5 for now.
The price is now correcting in wave (B), which appears to be nearing
completion. It might form as a simple zigzag A-B-C and end up unfolding
at around 150.00. At that level, the size of wave (B) will be 23.6% of
wave (A). In that scenario, long positions should be considered.

### Weekly [ZECUSD][8] trading plan:

Buy 131.61, TP 150.00
