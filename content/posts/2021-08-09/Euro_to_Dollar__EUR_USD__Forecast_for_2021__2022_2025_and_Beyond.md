...
The current rate of the EUR/USD pair is $1.17353. Below, you can see an
...
## Euro/dollar weekly price forecast as of 09.08.2021

The euro price collapsed last week. Friday's US jobs report only
exacerbated the situation. As a result, the price dropped to the
​​support zone 1.1789 - 1.1762. Until this zone is broken out, it is not
possible to consider new sales. Therefore, wait for further developments
and watch the buyers’ reaction to the test of strong levels.

If the price returns back to the support of 1.1789, it will be possible
to consider purchases in correction with the target at the July high.

If the price consolidates below level 1.1762, then it will be possible
to consider sales from the zone of 1.1789 - 1.1762 with a target at the
Target Zone 4 1.1562 - 1.1544.

### [EURUSD][1] Trading ideas for the week:

  1. Open buy positions according to the pattern in 1.1789 - 1.1762. TakeProfit: 1.1905. StopLoss: according to the pattern rules.

  2. If the price consolidates below level 1.1762, sell from the zone of 1.1789 - 1.1762. TakeProfit: Target Zone 4 1.1562 - 1.1544. StopLoss: 1.1837.
