...
**The current price of gold is $1 723.55.**
...
## Gold weekly price forecast as of 01.03.2021

Gold, trading in the medium-term downtrend, broke through the local low
last week. The price broke out Target Zone 2 [1759 - 1749]. If the price
consolidates below the support this week, it will be relevant to sell
gold down to Target Zone 3 [1659 – 1649]. The trend border shifts to the
level of [1838 - 1827].

The RSI indicates that gold is oversold. There is forming a convergence.
Therefore, there should start an upward correction this week.

The correction will provide a chance to enter new sell trades. The
nearest resistance, where one could enter a sell trade, is 1786 – 1770.
If the price breaks out this zone upside, it will test the key
resistance.
...
### [XAUUSD][14] Trading ideas for the week:
  ...
  1. Sell according to the pattern in the zone of [1786 - 1770]. TakeProfit: 1720. StopLoss: according to the pattern rules.
  2. If the price breaks out level 1786, buy at 1778. TakeProfit: Target Zone [1838 - 1827]. StopLoss: 1750.
