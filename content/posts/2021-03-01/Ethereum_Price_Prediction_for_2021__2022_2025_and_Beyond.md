...
## Weekly Elliott wave Ethereum analysis as of 01.03.2021

The [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) ETHUSD price chart displays the structure of the upward simple
zigzag A-B-C, which seems to have completed. The sub-waves A and C are
upward five-wave impulses; correction B is a bearish triple zigzag
[W]-[X]-[Y]-[X]-[Z]. There is currently unfolding the initial element of
the new bearish trend, which could complete as a double zigzag W-X-Y.
Let us study the most recent chart section in a shorter timeframe.

The first sub-wave W of the downward double zigzag W-X-Y must have
completed. If the assumption is correct, the Ethereum price should start
rising in the upward linking wave X to a level of 1750.00, where wave X
will be 61.8% of wave W, according to Fibonacci retracements. After wave
X finishes, the market will start declining in the final wave Y, as
outlined in the chart.

### Weekly [ETHUSD][1] trading plan

Buy 1426.36, TP 1750.00
...
ETH is traded at $1 522.84. Below you can see how the price of ETH
