...
## Weekly Elliott wave NEO analysis as of 01.03.2021

A large ascending zigzag A-B-C formed on the NEOUSD cryptocurrency
pair's chart. The first two parts of the zigzag are fully completed: we
see the ultimate part of the ascending impulse wave A and the corrective
wave B, shaped like a triple zigzag. The first part of the final impulse
wave C is unfolding at the moment. Only the first two small sub-waves
[1] and [2] have formed so far. Let’s have a detailed look at the last
segment of the chart on the H8 time frame.

Wave [1] is a bullish impulse, and correction [2] is a bearish double
zigzag. The first part of the ascending impulsive wave [3] is developing
at the moment. The impulse wave (1) of a smaller degree has formed
recently, and the price is declining in corrective wave (2) now.
Correction (2)'s structure may be simple and the correction may form as
zigzag A-B-C, as the chart suggests. The middle part of correction (2),
i.e., wave B, is expected to develop up to the level of 45.70 in the
nearest time, where its size will amount to 61.8% of impulse A.
