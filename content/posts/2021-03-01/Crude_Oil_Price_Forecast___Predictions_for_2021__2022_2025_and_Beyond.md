...
The price for today is $60.318. The chart below is interactive, so you
can easily see the dynamics.
...
## Oil weekly price forecast as of 01.03.2021

As I expected, following a three-week divergence between the oil price
chart and the RSI oscillator, the market has started a correction.

Last week, buyers broke out Target Zone 5 [59.82 – 59.31] and tried to
drive the price up to Target Zone 6 [64.92 - 64.41]. The price did not
reach the margin zone but formed a resistance level at 62.75. The
attempts to consolidate the price above the level resulted in a false
breakout.

The price closed below level 62.75 last week. A sell signal will appear
when the price breaks out the support at 61.06. In this case, the market
could go down to the trend key support zone of [59.18 – 58.73]. If the
price breaks out the support, the medium-term oil trend will reverse
down.

If the buyers hold the level [59.18 – 58.73], and there appears a buy
pattern, the bulls will be able to reach another upside target and break
through February’s high.

### [USCrude][3] Trading ideas for the week:

  1. If level 61.06 is broken out, sell at 61.95. TakeProfit: Target Zone [59.18 - 58.73]. StopLoss: 63.51.
  2. If the price reaches level 59.00, sell at 61.06. TakeProfit: 57.65. StopLoss: 62.48.
