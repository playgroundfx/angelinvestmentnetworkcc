...
## Weekly Elliott wave ZCash analysis as of 01.03.2021

The ZECUSD cryptocurrency pair's current structure indicates that a
large standard zigzag A-B-C is developing. Sub-waves A and B are fully
completed as parts of that zigzag. A is an impulse and B is the
impulse's correction formed as a triple zigzag [W]-[X]-[Y]-[X]-[Z]. The
initial part of an ascending impulsive wave C is developing at the
moment. Let's examine the ultimate part of the chart on the H8 time
frame.

After the bearish correction [2] formed as a double zigzag (W)-(X)-(Y),
the market started plotting the first part of the third impulsive wave.
The price was growing in impulse (1) of a smaller degree from early
January 2021 to mid-February 2021. That impulse appears to have fully
formed, and we can expect a zigzag-shaped correction (2) to unfold.
Impulse A is expected to end in the nearest time. The corrective wave B
will then push the market up to the level of 153.00. At that level, the
size of wave B will be 61.8% of wave A.

### Weekly [ZECUSD][8] trading plan:

Buy 109.21, TP 153.00
