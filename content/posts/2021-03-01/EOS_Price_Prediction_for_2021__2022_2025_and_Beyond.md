...
## Weekly Elliott wave EOS analysis as of 01.03.2021

The EOSUSD cryptocurrency pair continues forming a deep multi-year
correction B in the form of a triple bearish zigzag [W]-[X]-[Y]-[X]-[Z].
The correction is the middle part of the global ascending zigzag. As of
today, the ultimate zigzag-shaped wave [Z] is probably developing as a
simple zigzag (A)-(B)-(C). Let’s have a look at that wave on the H8 time
frame.

Only the first part of wave [Z] — the bearish impulse wave (A) — is
unfolding at this moment. It consists of five sub-waves of a smaller
degree 1-2-3-4-5. The first two parts of that impulse formation are
fully completed, and sub-wave 3 is probably nearing completion. The
price is expected to fall in wave 3 in the nearest time. After a small
pullback in correction 4, the market will start forming the ultimate
wave 5. The whole wave (A) may finish forming at 2.47, the previous low
marked by wave B.
