...
now, the rewards per block are [12.5 coins][7] and will decrease to 6.25
...
The LTC price today is $171.07. This value is interactive, so you will
...
( {{count}} {{title}} )
   ...
   6. my.liteforex.com/trading/?category=analysts-opinions&slug=[Litecoin](https://www.playgroundfx.com/blog/litecoin-creator/)-price-prediction-forecast&type=currency
