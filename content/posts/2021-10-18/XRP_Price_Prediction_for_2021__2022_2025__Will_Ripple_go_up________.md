...
## Weekly Elliott wave Ripple analysis as of 18.10.2021

The XRPUSD market continues forming the large corrective wave B as a
global double zigzag [W]-[X]-[Y]. The motive wave [W] completed as a
triple zigzag, and the linking wave [X] finished as a double zigzag. At
the time of writing, there is unfolding the final motive wave [Y], which
could complete as a double zigzag (W)-(X)-(Y), like the [X] wave, where
the (Y) wave might finish as a triple zigzag W-X-Y-XX-Z, as outlined in
the chart. Let us study the most recent chart section in more detail in
the eight-hour timeframe.

Sub-waves (W) and (X) have completed as simple zigzags in the bearish
motive wave [Y]. There is forming the final sub-wave (Y). It could have
a complex structure of a triple zigzag, where the first sub-wave W has
completed. The price is now rising in the zigzag-shaped linking wave X,
which should end around level 1.276. At this level, the X wave will
retrace the W wave by 76.4%. One could enter long trades in the current
situation.
...
The Ripple price today on 19.10.2021 is $1.08000. Looking at the full
