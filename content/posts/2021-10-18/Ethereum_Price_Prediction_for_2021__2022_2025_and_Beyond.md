...
## Weekly Elliott wave Ethereum analysis as of 18.10.2021

The ETHUSD market has completed the large zigzag A-B-C, which had been
developing for more than 4 years. Therefore, the most recent chart
section displays the beginning of the new bearish trend. There must be
developing the descending zigzag A-B-C. The first leg of the zigzag,
sub-wave A must have completed as an impulse. There is developing
corrective wave B. Let us explore the most recent chart section in the
H8 timeframe.

The upward corrective wave B is unfolding as simple zigzag [A]-[B]-[C].
The upward wave [A] has completed as a five-wave impulse. The bearish
correction [B] is a standard three-wave zigzag. The price has been
rising in the upward wave [C], unfolding as an impulse marked by the
blue letters (1)-(2)-(3)-(4)-(5). The Ethereum price could be rising to
a level of 4030.00, marked by wave [A]. Next, the market could turn down
and start declining.

### Weekly [ETHUSD][2] trading plan:

Buy 3896.79, TP 4030.00
...
ETH is traded at $3 724.81. Below you can see how the price of ETH
