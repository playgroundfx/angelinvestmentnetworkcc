...
## Weekly Elliott wave Litecoin analysis as of 18.10.2021

The LTCUSD market seems to have completed the global simple zigzag
composed of sub-waves A-B-C. Sub-waves A and C are simple impulses. Sub-
wave B is a correction completed as a triple combination composed of
sub-waves [W]-[X]-[Y]-[X]-[Z]. There is forming a new bearish trend,
possibly, as a zigzag [A]-[B]-[C]. Let us study the chart structure in
more detail in the eight-hour timeframe.

After the completion of the down impulse wave [A] composed of sub-waves
(1)-(2)-(3)-(4)-(5), the price has started rising in corrective wave
[B], likely unfolding as a simple zigzag A)-(B)-(C), which is about to
end soon. The upward wave (A) has completed as an impulse, the bearish
correction (B) is a simple zigzag A-B-C. There is unfolding the impulse
wave (C), composed of sub-waves 1-2-3-4-5, which should finish around
level 232.00, where impulse (A) completed earlier. The market should
continue rising in sub-waves 3-4-5, as outlined in the chart. One could
enter buy trades in the current situation.

### Weekly [LTCUSD][3] trading plan:

Buy 186.16, TP 232.00
...
The Litecoin price today is  $184.50. This value is interactive so that
