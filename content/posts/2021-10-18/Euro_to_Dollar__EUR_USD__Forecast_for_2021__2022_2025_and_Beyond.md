...
The current rate of the EUR/USD pair is $1.16108. Below, you can see an
...
## Euro/dollar weekly price forecast as of 18.10.2021

After the price had reached Target Zone 4, 1.1562 – 1.1544, in the
medium-term downtrend, it grew and is now approaching the resistance
level 1.1632. The EURUSD growth is a correction, whose possible target
is the trend border 1.1718 – 1.1700.

Amid the above-indicated possible correction, I recommend entering long
trades at a level of around  1.1600. Take profit for this trade will be
around 1.1667.

If the price continues falling and breaks out Target Zone 4, we shall
enter sell trades in the trend with a target in Target Zone 5, 1.1386 –
1.1368. This scenario will be relevant when the price consolidates below
level 1.1544.

### [EURUSD][1] Trading ideas for the week:

  1.  **Aggressively:** buy at level 1.1575. TakeProfit: 1.1667. StopLoss: 1.1542.

  2. Sell according to the pattern in the zone of 1.1718 – 1.1667. TakeProfit: 1.1527. StopLoss: according to the pattern rules.
