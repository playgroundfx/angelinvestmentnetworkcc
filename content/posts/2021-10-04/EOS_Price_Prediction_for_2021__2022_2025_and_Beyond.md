...
## Weekly Elliott wave EOS analysis as of 04.10.2021

The EOSUSD market is forming the linking wave (X) as a part of the large
double zigzag. The linking wave (X) has a complex structure of a double
combination W-X-Y. The first two legs of the pattern have completed.
There is now unfolding the initial part of the final motive wave Y,
which could complete as a double zigzag [W]-[X]-[Y], like waves W and X.
An approximate structure of the potential Y wave is outlined in the
chart. Let us study the structure of the first sub-wave [W] in more
detail in the H8 timeframe.

In the [W] wave, the down wave (A) has finished as a five-wave impulse
1-2-3-4-5. The corrective wave (B) must have completed as a simple
zigzag A-B-C, where A is a leading diagonal. Therefore, there could be
unfolding the initial part of the bearish wave, which is an impulse. Two
short sub-waves 1 and 2 have finished, and impulse [1] of a smaller
degree is also complete. Correction [2] should soon end, and the price
will continue declining in the third wave to a level below 3.56, marked
by impulse [1].
