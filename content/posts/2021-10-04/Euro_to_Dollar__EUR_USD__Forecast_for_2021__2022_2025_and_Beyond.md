...
The current rate of the EUR/USD pair is $1.16183. Below, you can see an
...
## Euro/dollar weekly price forecast as of 04.10.2021

The EURUSD broke out Target Zone 1.1733 - 1.1715 last week and continued
falling. The price reached Target Zone 4, 1.1562 - 1.1544, the primary
target in the medium-term downtrend.

The RSI indicator signals that the market is oversold, so a corrective
pattern should form this week.

To trade in the correction, one should expect an upward momentum and buy
the euro with a target of $1.1667.

One should consider entering new sell trades in the trend at strong
resistance levels. The first and the nearest resistance level is 1.1667.
The key resistance is in the one of 1.1756 - 1.1738.

### [EURUSD][1] Trading ideas for the week:

Buy according to the pattern in Target Zone 4, 1.1562 - 1.1544.
TakeProfit: 1.1667. StopLoss: according to the pattern rules.
