...
Bitcoin price today (05.10.2021) is $49 010.47.
...
## Weekly Elliott wave Bitcoin analysis as of 04.10.2021

The BTCUSD market is forming the initial part of the new bullish zigzag.
The first subwave (A) must have completed as an impulse composed of sub-
waves 1-2-3-4-5 marked with red numbers. There should be forming the
bearish correction as a standard zigzag. So far, the impulse wave [A]
has finished, and the [B] correction is unfolding. Let us study the most
recent chart section in the eight-hour timeframe.

After the down impulse wave [A] finished, the market has started rising
in the corrective wave [B], unfolding as a simple zigzag  (A)-(B)-(C).
Impulse (A) and correction (B) have completed. The Bitcoin price should
be rising in the (C) impulse to a level of 54000.00, where the (C) wave
will be 61.8% of the (A) wave, according to the Fibonacci retracements.

### Weekly [BTCUSD][1] trading plan:

Buy 47740.00, TP 54000.00
...
If the current price is at $49 010.47, what is the Bitcoin future value?
...
the current Bitcoin price is at $49 010.47. Usually, it’s a better idea
