...
## Weekly Elliott wave Litecoin analysis as of 04.10.2021

The LTCUSD market should have completed the simple global zigzag,
composed of three major sub-waves A-B-C. Sub-waves A and C are standard
impulses. Correction B is a triple combination composed of sub-waves
[W]-[X]-[Y]-[X]-[Z]. There is developing a new bearish trend, which
could be a zigzag [A]-[B]-[C]. Let us study the most recent chart
section in more detail in the eight-hour timeframe.

It is clear from the H8 timeframe that the impulse down wave [A]
finished in late July. Next, the price was corrected in wave [B] for
more than two months. The [B] correction seems to have completed as a
simple zigzag (A)-(B)-(C). There should be forming the inceptive element
of the descending impulse. The first two legs of the potential impulse,
sub-waves (1) and (2), look complete. There should be developing sub-
waves of a smaller degree, which will form the third sub-wave, and the
price could go to a level below 138.80, as outlined in the chart.

### Weekly [LTCUSD][3] trading plan:

Sell 166.17 TP 138.80
...
The Litecoin price today is  $167.90. This value is interactive so that
