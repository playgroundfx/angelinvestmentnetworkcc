...
The current rate of the EUR/USD pair is $1.20639. Below, you can see an
...
## Euro/dollar ****weekly price forecast as of 03.05.2021

The euro/dollar price has not reached the Target Zone 3, 1.2200 –
1.2184. The price is being corrected now. The correction target is the
border of the medium-term uptrend 1.1973 – 1.1956.

After the price tests the margin zone of 1.1973 – 1.1956, one could
start looking for a buy pattern. The resistance level of 1.2141 could be
referred to as a major target.

It will be relevant to sell the euro if the price breaks out the trend
key support level and consolidates below. If so, the target will be the
lower Target Zone 2, 1.1997 - 1.1780.

### [EURUSD][1] Trading ideas for the week:

Buy according to the pattern in the Target Zone 1.1973 - 1.1956.
TakeProfit: 1.2141. StopLoss: according to the pattern rules.
