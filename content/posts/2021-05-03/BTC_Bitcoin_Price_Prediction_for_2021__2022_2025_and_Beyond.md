...
Bitcoin price today (04.05.2021) is $56 710.54.
...
## Weekly Elliott wave Bitcoin analysis as of 03.05.2021

The [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) BTCUSD chart displays the final section of the impulse wave
(A). Wave (A) must have completed, and there is forming the initial part
of the bearish correction, There is likely to be forming the impulse
down wave composed of the sub-waves 1-2-3-4-5. The first small sub-wave
1 seems to have completed, and corrective wave 2 is still developing.
Let us see the most recent chart section in more detail.

After the (A) impulse completed, the market has turned down and started
declining. There is now forming the bearish impulse, with wave 1
completed inside. The price should be moving up in wave 2. Wave 2 should
end at a level of 60470.00, where it will retrace wave 1 by 76.4.%.
Next, the price will turn down and start declining. One could enter long
positions in the current situation.

### Weekly [BTCUSD][1] trading plan:

Buy 57482.50, TP 60470.00
...
If the current price is at $56 710.54, what is the Bitcoin future value?
...
the current Bitcoin price is at $56 710.54. Usually, it’s a better idea
