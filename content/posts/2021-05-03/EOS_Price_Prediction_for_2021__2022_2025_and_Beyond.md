...
## Weekly Elliott wave EOS analysis as of 03.05.2021

The EOSUSD's pattern is developing as a global zigzag A-B-C. Only the
first part of the zigzag - impulse wave A - has fully formed. A
descending corrective wave B is developing as a triple zigzag
[W]-[X]-[Y]-[X]-[Z]. The triple zigzag's ultimate wave [Z] is forming at
the moment. Let’s have a detailed look at the last segment of the chart
in a shorter time frame.

The first part of a descending impulse wave, which will start a big
motive wave [Z], appears to be forming at the moment. Most likely, wave
1 has been completed, so the price may rise in corrective wave 2 in the
near time. Its size is expected to be 76.4% of wave 1, based on Fibo
ratios, so we may see the correction's ending point at around 7.82.
Thus, we can open long positions to make profits at that level.
