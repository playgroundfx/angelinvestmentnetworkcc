...
## Weekly Elliott wave Ripple analysis as of 03.05.2021

The XRPUSD is forming a large simple zigzag A-B-C. There have completed
two legs of the zigzag, impulse A and the downward correction B, which
is a triple zigzag. There is now forming the initial part of the final
bullish impulse C. At the time of writing, there have finished its two
parts, small sub-waves [1] and [2]. Let us study the most recent chart
section in more detail in the eight-hour timeframe.

There has been forming the upward impulse wave [1] since January. Wave
[1] is composed of five sub-waves (1)-(2)-(3)-(4)-(5), where corrective
wave (4) is a contracting triangle. The bearish corrective wave [2] has
completed as a zigzag. The price should be rising in the new impulse
wave to a level higher than the high marked by wave [1], that is, above
level 1.961. One could enter long positions in the current situation
with the target at level 1.961.
...
The Ripple price today is $1.54569. Looking at the full price chart
