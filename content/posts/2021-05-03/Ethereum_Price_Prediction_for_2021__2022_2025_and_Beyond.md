...
## Weekly Elliott wave Ethereum analysis as of ****03.05.2021

The ETHUSD market is forming a zigzag-shaped pattern. There should be
unfolding the final part of the upward impulse wave C. The price should
stop rising at the end of wave C, which should complete at a level of
3255.00. After the indicated level is reached by the price, the market
could turn down and start forming a new bear trend. Let us explore the
chart structure in more detail in a shorter timeframe.

The eight-hour timeframe displays the structure of the impulse upwave
[5], being an element of impulse C. In late March, there completed the
sideways corrective wave (4) as a double three W-X-Y. There is now
forming the final bullish impulse (5), namely its final sub-wave 5. The
price should go up to a level of 3255.00. Next, the market will turn
down and start declining. One could enter purchases in the current
situation.

### Weekly [ETHUSD][1] trading plan:

Buy 2937.82, TP 3255.00
...
ETH is traded at $3 284.70. Below you can see how the price of ETH
