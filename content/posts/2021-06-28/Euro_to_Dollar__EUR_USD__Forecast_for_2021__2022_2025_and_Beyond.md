...
The current rate of the EUR/USD pair is $1.19233. Below, you can see an
...
## Euro/dollar ****weekly price forecast as of 28.06.2021

Last week, the euro price was being corrected following a drop in the
week from June 14 to June 18. The maximum correction target is in the
zone of 1.2061 – 1.2023. After this zone is tested, one could enter sell
trades according to the pattern with the following targets:

  1. level 1.1857;

  2. Target Zone 3, 1.1738 – 1.1720.

It will be relevant to buy if the trend reverses up via the breakout of
level 1.2061. If so, the target will be the upper Target Zone 2, 1.2217
– 1.2199.
