...
Bitcoin price today (29.06.2021) is $34 672.23.
...
## Weekly Elliott wave Bitcoin analysis as of 28.06.2021

The BTCUSD market is forming a long-term zigzag-shaped trend. The long
wave (A) must have finished recently as an upward five-wave impulse
1-2-3-4-5. The most recent chart section displays the initial part of
the bearish corrective wave that could be unfolding as a down zigzag
[A]-[B]-[C]. Let us study the chart structure in more detail in the
eight-hour timeframe.

In April, the market turned down and started declining, forming the
initial part of the corrective trend. There should be developing a
descending zigzag. There is unfolding the first sub-wave of the zigzag,
impulse [A] composed of five sub-waves (1)-(2)-(3)-(4)-(5). Wave (5)
could finish at a level of 28570.00. Next, the Bitcoin price should
start rising in the corrective wave [B], unfolding as a zigzag
(A)-(B)-(C), to a level of 46700.00. At this level, wave [B] will
retrace wave [A] by 50%.

### Weekly [BTCUSD][1] trading plan:

Sell 33129.50, TP 28570.00
...
If the current price is at $34 672.23, what is the Bitcoin future value?
...
the current Bitcoin price is at $34 672.23. Usually, it’s a better idea
