...
January 2021. The NEO/USD today’s rate is: $98.18
...
## Weekly Elliott wave NEO analysis as of 10.05.2021

The NEOUSD market continues forming the upward zigzag A-B-C. The bullish
impulse wave A and the triple zigzag B have completed. The second
impulse wave C has just started unfolding. So far, there have completed
two small sub-waves [1] and [2], and sub-waves (1) and (2) of a smaller
degree, which are the sub-waves of impulse [3]. Let us study the market
structure in more detail in the eight-hour timeframe.

In late March-early April, the market started forming the beginning of
the upward impulse wave (3). In wave (3), there must have completed sub-
waves 1 and 2, where wave 1 is a bullish impulse, wave 2 is a bearish
correction formed as a simple zigzag [A]-[B]-[C]. There has also
completed impulse wave [1] of a smaller degree. In the near future, the
price should be declining in correction [2] to a level of 89.60, where
correction [2] will reach the Fibonacci ratio of 76.4% of wave [1].

### Weekly [NEOUSD][2] trading plan structure:

Sell 115.17, TP 89.60
