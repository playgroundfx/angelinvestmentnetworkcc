...
## Weekly Elliott wave Ethereum analysis as of 24.05.2021

The ETHUSD market has been forming a simple upward zigzag, which seems
to be complete. Waves A and C are bullish five-wave impulses. Wave B is
a correction, completed as a bearish triple zigzag [W]-[X]-[Y]-[X]-[Z].
Therefore, the market must be forming the inceptive part of a new trend.
There could be unfolding the beginning of the impulse down wave. Let us
study the market structure in more detail in the eight-hour timeframe.

Sub-waves 1 and 2 (marked with red) seem to have completed in the new
impulse wave. Next, the market has started forming the beginning of the
third wave that could end as an impulse [1]-[2]-[3]-[4]-[5]. There must
have completed the first little wave [1]. There should be developing the
corrective upwave [2] as a standard zigzag (A)-(B)-(C). Wave [2] should
end at a level of 3250.00, where it will be 61.8% of wave [1], which is
a common ratio in impulses.

### Weekly [ETHUSD][1] trading plan:

Buy 2209.17, TP 3250.00
...
ETH is traded at $2 649.10. Below you can see how the price of ETH
