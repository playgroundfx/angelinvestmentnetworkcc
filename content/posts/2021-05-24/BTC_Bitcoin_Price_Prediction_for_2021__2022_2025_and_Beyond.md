...
Bitcoin price today (25.05.2021) is $39 220.80.
...
## Weekly Elliott wave Bitcoin analysis as of 24.05.2021

Bitcoin continues forming a long-term uptrend as a regular zigzag
(A)-(B)-(C). The first wave (A) seems to have completed as a five-wave
bullish impulse composed of sub-waves 1-2-3-4-5. There is now developing
the initial part of the bearish corrective wave. The first leg could
complete as an impulse 1-2-3-4-5. There have finished the first two sub-
waves 1 and 2, outlined in the chart.

It is clear from the eight-hour timeframe that, following the completion
of impulse wave 1 and the zigzag-shaped corrective wave 2, the market
has started unfolding the initial part of the third wave. There must
have completed the descending wave [1] as an impulse. There seem to have
completed the first two legs of the upward correction [2], which could
end as a simple zigzag (A)-(B)-(C). The Bitcoin price should be rising
in the impulse wave (C), which will conclude wave [2] at a level around
48300.00. At this level, wave [2] will retrace wave [1] by 61.8%.

### Weekly [BTCUSD][1] trading plan:

Buy 37039.50, TP 48300.00
...
If the current price is at $39 220.80, what is the Bitcoin future value?
...
the current Bitcoin price is at $39 220.80. Usually, it’s a better idea
