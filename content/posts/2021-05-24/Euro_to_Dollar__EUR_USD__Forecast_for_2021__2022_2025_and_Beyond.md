...
The current rate of the EUR/USD pair is $1.22155. Below, you can see an
...
The euro-dollar reached the Target Zone 3, 1.2200 — 1.2184, in the
medium-term uptrend. The buyers didn’t consolidate the price above the
zone. As a result, the price rolled down below the resistance and
started a correction.

If the correction continues, the price could move to the trend border
zone 1.2069 — 1.2051. After the trend border is tested, one could look
for new purchases according to the pattern. The upside target will be
level 1.2231.

If the price breaks out the trend key support, we shall enter euro sell
trades with the downside target in the Target Zone 2, 1.1893 — 1.1875.

### [EURUSD][1] Trading ideas for the week:

Buy according to the pattern in the Target Zone 1.2069 — 1.2051.
TakeProfit: 1.2231. StopLoss: according to the pattern rules.
