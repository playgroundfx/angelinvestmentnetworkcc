...
## Weekly Elliott wave EOS analysis as of 24.05.2021

The EOSUSD market must be forming a global double zigzag (W)-(X)-(Y).
The first motive sub-wave (W) has finished, and there is unfolding the
linking down wave (X) as a double zigzag W-X-Y. The first motive wave W
and the linking wave X are double zigzags. The final wave Y should have
a similar structure; let us study it in more detail in the eight-hour
timeframe.

After the linking wave X completed as a double zigzag, the market has
declined in the (A), completed by now. There could be forming the upward
corrective wave (B), which could retrace impulse (A) by 50%. Such
proportions are common in impulses. Therefore, the price should be
rising towards a level of 9.40. One could enter buy trades in the
current situation.
