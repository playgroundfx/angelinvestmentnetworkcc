...
## Weekly Elliott wave ZCash analysis as of 24.05.2021

The ZECUSD is forming a global corrective trend. There is unfolding a
simple zigzag (A)-(B)-(C). The first leg of the zigzag, wave (A), has
finished. There is unfolding the bearish correction (B) as a double
zigzag W-X-Y. Wave W is a triple zigzag, wave X is a double zigzag. Wave
Y has just started unfolding as a double zigzag. Let us study the most
recent chart section in a shorter timeframe.

After the completion of wave X, the price has started declining. There
should have completed the impulse wave (A). If the assumption is
correct, the market should be rising in the corrective wave (B). The
price could reach level 240.00. After the (B) wave is complete, the
market should turn down and start declining again. At level 240.00, wave
(B) will be 50% of the impulse wave (A).

### Weekly [ZECUSD][8] trading plan:

Buy 139.20, TP 240.00
