...
## Weekly Elliott wave ZCash analysis as of 12.04.2021

In the long term, the ZECUSD is forming an upward corrective pattern as
a simple zigzag A-B-C. The impulse wave A and the bearish corrective
wave B have completed. Wave B is a triple zigzag. The market is now
forming the initial part of the final impulse wave C. There have
completed the first two legs, the sub-waves [1]-[2]. Let us see the
market structure in more detail in the eight-hour timeframe.

After the market completed the corrective wave [2], composed of the sub-
waves (W)-(X)-(Y), there has started the initial part of the third
impulse wave. There have formed impulse (1) and correction (2) opposite
the impulse. There is developing the sub-wave 1 as a regular five-wave
impulse [1]-[2]-[3]-[4]-[5]. Wave 1 should end at a level of 245.00.
After the indicated level is reached, the market should be moving down
in the corrective sub-wave 2, as outlined in the chart. One could
consider buy trades in the current situation.

### Weekly [ZECUSD][8] trading plan:

Buy 220.19, TP 245.00
