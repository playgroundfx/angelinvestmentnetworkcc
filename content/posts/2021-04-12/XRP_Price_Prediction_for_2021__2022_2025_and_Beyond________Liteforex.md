...
## Weekly Elliott wave Ripple analysis as of 12.04.2021

The XRPUSD, like in the previous trading days, is forming a large simple
zigzag. Within this zigzag, there have completed the first two legs, the
impulse wave A and the corrective down wave B, which is a triple zigzag
[W]-[X]-[Y]-[X]-[Z]. There is now forming the final wave C, which, like
the A wave, could end as an impulse. Let us study the structure of the
most recent chart section in the H8 chart.

After the triple zigzag B completed, the market has formed sub-waves
[1]-[2]-[3]-[4], which are making the initial part of wave C of a larger
degree. The horizontal corrective wave [4] must have completed as a
triangle. Wave [4] is a contracting triangle. After this correction
completed, the small sub-waves (1) and (2) have formed. Next, the price
has started rising in impulse (3). Presumably, the price will reach
level 1.730, next, there is a possible decline in wave (4).
...
The Ripple price today is $1.37838. Looking at the full price chart
