...
## Weekly Elliott wave Litecoin analysis as of 12.04.2021

The LTCUSD is forming the global corrective trend as an upward zigzag
A-B-C. Wave A is a bullish impulse, the down corrective wave B is a
bearish triple zigzag [W]-[X]-[Y]-[X]-[Z]. The price is now rising in
the final impulse wave C composed of the sub-waves [1]-[2]-[3]-[4]-[5].
The C impulse is likely to end at a level of around 348.00. At this
level, the final wave [5] will reach 76.4% of wave [3]. Let us study the
most recent chart section in a shorter timeframe.

The eight-hour timeframe displays the structure of the impulse wave
[1]-[2]-[3]-[4]-[5]. Within this wave of a larger degree, the sideways
corrective wave [4] has completed as a contracting horizontal triangle
(A)-(B)-(C)-(D)-(E). Over the next few days, there should be forming
waves (3)-(4)-(5), which should conclude the final wave [5] at a level
of 348.00, as outlined in the chart. One could consider long trades with
a target at level 348.00.

### Weekly[ LTCUSD][2] trading plan:

Buy 255.30, TP 348.00
...
The LTC price today is $244.09. This value is interactive, so you will
