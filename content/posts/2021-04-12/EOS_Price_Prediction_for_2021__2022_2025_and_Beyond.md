...
## Weekly Elliott wave EOS analysis as of 12.04.2021

The EOSUSD is forming a global zigzag A-B-C, with the middle leg, wave
B, forming inside. The down corrective wave B is forming as a triple
zigzag [W]-[X]-[Y]-[X]-[Z]. The two motive waves [W] and [Y] have
completed, as well as the first linking wave [X]. There is now forming
the second linking wave [X] as a double zigzag (W)-(X)-(Y). Let us study
this wave in a shorter timeframe.

The sub-waves (W) and (X) have completed in the double zigzag
(W)-(X)-(Y). There is now forming the upward wave (Y) as a double zigzag
W-X-Y. The final zigzag Y, composed of the sub-waves [A]-[B]-[C], should
conclude the (Y) wave. The price should be rising in the impulse wave
[C], namely in its fifth leg, to a level of 7.70. Next, the market will
turn down and start declining.
