...
## Weekly Elliott wave Ethereum analysis as of 12.04.2021

The Ethereum is still forming the global simple zigzag A-B-C. After the
corrective down wave B finished as a triple zigzag [W]-[X]-[Y]-[X]-[Z],
the market has started rising in the final impulse wave C. Wave C is
composed of five sub-waves [1]-[2]-[3]-[4]-[5]. The first four legs of
the pattern have completed, and the final sub-wave [5] is still
unfolding. Let us study the market structure in a shorter timeframe.

Wave [5] is an upward five-wave impulse composed of the sub-waves
(1)-(2)-(3)-(4)-(5). There have completed the first four parts of the
impulse. The sideways correction (4) has recently completed as a double
three W-X-Y. The price is rising in the last impulse wave (5) towards a
level of 2300.00. After the price reaches this level, the market could
turn down and start a new bearish trend with a target below the previous
low of 1540.00.

### Weekly [ETHUSD][1] trading plan:

Buy 2128.06, TP 2300.00
...
ETH is traded at $2 144.75. Below you can see how the price of ETH
