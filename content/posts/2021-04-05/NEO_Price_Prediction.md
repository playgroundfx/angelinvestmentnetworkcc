...
## Weekly Elliott wave NEO analysis as of 05.04.2021

The NEO market structure is similar to that of the other major
cryptocurrencies. There is developing a simple zigzag A-B-C, with the
upward impulse wave A completed inside. Correction B has also completed,
it is a triple zigzag [W]-[X]-[Y]-[X]-[Z]. After the completion of the B
correction, the market has started rising in the initial part of the
final impulse wave C. Let’s study the most recent chart section in the
H8 timeframe.

After the corrective wave [2] completed as a double zigzag (W)-(X)-(Y),
the price started rising in the initial part of the impulse wave. There
have completed two sub-waves, (1) and (2), so far. There is currently
forming sub-wave 1, and it should end as a leading diagonal. In the near
future, the market should continue growing in the final sub-wave [5] of
the leading diagonal to a level of 62.00. Next, the market could reverse
and start moving in the opposite direction, as outlined in the chart.
