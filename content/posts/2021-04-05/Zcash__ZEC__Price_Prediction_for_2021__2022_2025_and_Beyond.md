...
## Weekly Elliott wave ZCash analysis as of 05.04.2021

The current ZECUSD market is forming the upward corrective pattern as a
zigzag A-B-C. The impulse wave A and the bearish correction B must have
completed. Wave B is a triple zigzag. The market is now developing the
initial part of the final impulse wave C. There have completed the C
wave’s first two legs – the sub-waves [1]-[2]. Let us study the market
structure in more detail in the eight-hour timeframe.

In late December 2020, the market completed the corrective wave [2],
composed of the sub-waves (W)-(X)-(Y). Next, there has started
developing the initial part of the third impulse wave. There have
finished impulse (1) and correction (2) opposite the impulse. There is
currently unfolding sub-wave 1 as a leading diagonal, as the end of sub-
wave [4] is beyond the end of sub-wave [1]. Wave 1 should finish at a
level of around 210.00. One could consider buy trades in the current
situation.

### Weekly[ ZECUSD][8] trading plan:

Buy 184.80, TP 210.00
