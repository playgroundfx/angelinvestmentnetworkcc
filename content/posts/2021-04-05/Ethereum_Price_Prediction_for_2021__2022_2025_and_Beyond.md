...
## Weekly Elliott wave Ethereum analysis as of 05.04.2021

The Ethereum market continues forming the regular global zigzag, like in
the previous trading weeks. The first two legs of the zigzag have
completed, the bullish impulse wave A and the triple bearish zigzag B.
Wave C is still unfolding as a regular five-wave impulse. There should
be developing the final section of the C impulse. Let us examine the
structure of the C wave in more detail in a shorter timeframe.

The eight-hour timeframe displays the structure of the final, fifth wave
of impulse C. Wave [5] is marked with five sub-waves of a smaller degree
and is also an impulse, like the bigger wave. The market must have
completed forming the corrective wave (4) as a double three W-X-Y. Next,
the price has started rising in wave (5). The market could grow up to a
level of 2170.00. Next, the ETHUSD could turn down and start declining,
as outlined in the chart.

### Weekly[ ETHUSD][1] trading plan:

Buy 2039.05, TP 2170.00
...
ETH is traded at $2 113.39. Below you can see how the price of ETH
