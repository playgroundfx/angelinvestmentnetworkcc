...
## Weekly Elliott wave Ripple analysis as of 05.04.2021

The XRPUSD market is forming a large standard zigzag A-B-C. Impulse wave
A completed at the high of 3.20. Next, there has started a deep
corrective wave B. The B correction is unfolding as a triple zigzag
[W]-[X]-[Y]-[X]-[Z]. The first three parts of this triple combination
look complete. The market is now forming the linking wave [X]. The [X]
wave is unfolding as a horizontal contracting triangle. Let us study its
structure in a shorter timeframe.

In the large triangle, there is now forming the corrective down wave (D)
as a simple zigzag. This zigzag is composed of three major sub-waves
A-B-C. The impulse wave A has finished, and the complex corrective wave
B, composed of the sub-waves [W]-[X]-[Y], must have also completed.
Therefore, the Ripple market is forming the beginning of the bearish
impulse wave C. Shortly, the price should be declining to a level below
0.448, marked by the linking wave (XX).
...
The Ripple price today is $0.87257. Looking at the full price chart
