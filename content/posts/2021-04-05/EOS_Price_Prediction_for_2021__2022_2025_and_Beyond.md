...
## Weekly Elliott wave EOS analysis as of 05.04.2021

Like other major cryptocurrencies, the EOSUSD market is forming the
upward zigzag A-B-C. After the upward impulse wave A completed, the
price has started falling in the bearish corrective wave B. Wave B is
unfolding as a triple zigzag [W]-[X]-[Y]-[X]-[Z]. Within the triple
zigzag, there is forming the second linking wave [X] as a double zigzag
(W)-(X)-(Y), like the first linking wave [X]. Let us study the most
recent chart section in the H8.

Within the linking wave [X], unfolding as an upward double zigzag
(W)-(X)-(Y), there have completed the first two sub-waves. Wave (W) is a
simple zigzag, wave (X) is a double zigzag. The final wave (Y) is still
developing, and it should end as a double combination W-X-Y. The final
impulse wave C should conclude wave Y. Wave C should end at level 7.00,
where the linking wave [X] will be 76.4% of wave [Y]. After the price
reaches the indicated level, the market could turn down and start
declining, as outlined in the chart.
