...
Bitcoin price today (24.08.2021) is $49 520.09.
...
## Weekly Elliott wave Bitcoin analysis as of 23.08.2021

It is clear from the BTCUSD [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) timeframe that the market has
completed the large impulse wave (A); next, the market has started
moving down. There is forming a simple down zigzag [A]-[B]-[C]. There
has formed the bearish impulse wave [A], and the price has started
rising in corrective wave [B]. The market should continue rising in the
correction. Let us study the most recent section in more detail in the
H8 chart.

The H8 BTCUSD price chart displays the structure of the impulse wave [A]
in detail. Wave [A] is composed of sub-waves (1)-(2)-(3)-(4)-(5), where
correction (4) is a double three W-X-Y. There is also the structure of
the bullish correction [B], which is a simple zigzag (A)-(B)-(C). The
[B] correction should end soon at a level of 51100.00, where wave [B]
will retrace the [A] wave by 61.8%.

### Weekly [BTCUSD][1] trading plan:

Buy 49011.00, TP 51100.00
...
If the current price is at $49 520.09, what is the Bitcoin future value?
...
the current Bitcoin price is at $49 520.09. Usually, it’s a better idea
