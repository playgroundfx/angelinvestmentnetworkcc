...
## Weekly Elliott wave EOS analysis as of 23.08.2021

The EOSUSD is forming a long-term double zigzag (W)-(X)-(Y). There must
have completed the first leg of the zigzag, sub-wave (W). There is
currently unfolding the linking wave (X) as a double combination W-X-Y.
Let us focus on the final sub-wave Y currently unfolding as a double
zigzag [W]-[X]-[Y], like sub-waves W and X. Let us explore the beginning
of the [W] wave in the H8 timeframe.

The [W] should be a simple zigzag. It is clear from the eight-hour
timeframe, that the impulse wave (A) has finished. The upward correction
(B) is currently forming. Within the (B) wave, the A wave has finished
as a leading diagonal, and the B wave has also completed. The market
should be rising in the C impulse, namely in the final, fifth, sub-wave,
to a level of 7.50. At this level, wave (B) will be 38.2% of wave (A).
One could enter buy trades under the current conditions.
