...
## Weekly Elliott wave Litecoin analysis as of 23.08.2021

The LTCUSD market has completed a zigzag-shaped pattern A-B-C. After the
final impulse wave C finished, the price has started falling. There must
be developing the initial part of the simple bearish zigzag [A]-[B]-[C].
Sub-wave [A] looks complete, and the corrective wave [B] is still
forming. Let us study the most recent chart section in more detail in
the eight-hour timeframe.

The descending wave [A] is an impulse (1)-(2)-(3)-(4)-(5), where
corrective wave (4) is a skewed triangle A-B-C-D-E. The upward
corrective wave [B] is currently unfolding as a standard zigzag
(A)-(B)-(C). Sub-waves (A) and (B) must have formed, and the upward
impulse wave (C) is still forming. The price could reach level 221.00,
where wave [B] will be 38.2% of wave [A].

### Weekly [LTCUSD][3] trading plan:

Buy 186.89, TP 221.00
...
The Litecoin price today is  $186.03. This value is interactive so that
