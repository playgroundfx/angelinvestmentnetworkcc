...
## Weekly Elliott wave Ripple analysis as of 29.03.2021

The [daily](https://www.fintecher.org/2020/03/03/forex-trading-daily-strategy/) XRPUSD price chart displays the corrective down wave B, which
is the sub-wave of the simple upward zigzag A-B-C. The B correction is
unfolding as a triple zigzag [W]-[X]-[Y]-[X]-[Z], where the first three
parts have completed. At the time of writing, there is developing the
second lining wave [X], which should be unfolding as a contracting
triangle. Let us explore this wave in more detail in the eight-hour
timeframe.

Within the triangle formation, there is developing the down wave (D).
Wave (D) is likely to be forming as a regular zigzag A-B-C. The impulse
wave A has finished, and there is now developing the corrective wave B.
The B wave is a double zigzag [W]-[X]-[Y], which is about to end soon.
The price should be rising in the impulse wave (С) of [Y] to a level of
0.645, where wave [W] ended. One could enter buy trades in the current
situation.
...
The Ripple price today is $0.55846. Looking at the full price chart
