...
The current rate of the EUR/USD pair is $1.17645. Below, you can see an
...
## Euro/dollar ****weekly price forecast as of 29.03.2021

The EURUSD medium-term downtrend continued, and the price broke out
Target zone 2, 1.1922 – 1.1906, at the beginning of last week. Next, the
market reached another target in Target zone 3, 1.1762 – 1.1746. If
sellers break out Target zone 3 and consolidate the price below, the
next downside target will be Target zone 4, 1.1602 — 1.1586.

Until the price breaks out Target zone 3, we can expect the EURUSD
correction. The nearest resistances are levels 1.1838, 1.1895. The trend
border is at level 1.1941.

This week, it will be relevant to enter new euro sales at a level of
$1.1838. If the price breaks out the level, one could enter trades in
the correction and enter long trades with the targets at 1.1895 and
1.1941.

### [EURUSD][1] Trading ideas for the week:

  1. Sell according to the pattern at level 1.1838. TakeProfit: 1.1746. StopLoss: according to the pattern rules.
  2. If level 1.1838 is broken out, buy. TakeProfit: 1.1895, 1.1941. StopLoss: 1.1790
