...
## Weekly Elliott wave ZCash analysis as of 12.07.2021

The ZECUSD market is forming a large bullish zigzag (A)-(B)-(C). The
first impulse wave (A) has completed. The market is forming a large
bearish corrective wave (B) as a double zigzag W-X-Y. Sub-wave W is a
triple zigzag, the upward linking wave X is a double zigzag. There is
forming the inceptive element of the final motive wave Y, which could be
a double zigzag, whose structure is roughly outlined in the chart. Let
us study the structure of the most recent chart section in more detail
in the H8 timeframe.

The market must have completed the impulse wave (A) in early July. The
(A) wave is composed of sub-waves 1-2-3-4-5. Next, the market turned up
and started forming an upward wave. There must be unfolding correction
(B) as a double zigzag W-X-Y, as outlined in the chart. The (B) wave
could end at a level of 193.30, where wave (B) will be  38.2% of wave
(A). After correction (B) completes, the market will resume declining in
the (C) impulse.

### Weekly [ZECUSD][8] trading plan:

Buy 107.93, TP 193.30
