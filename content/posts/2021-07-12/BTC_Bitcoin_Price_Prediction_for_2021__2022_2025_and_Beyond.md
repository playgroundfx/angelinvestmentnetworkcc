...
Bitcoin price today (13.07.2021) is $32 904.06.
...
## Weekly Elliott wave Bitcoin analysis as of 12.07.2021

The market must have completed the multi-year impulse wave [A], which is
an element of the global simple zigzag. There is unfolding the
corrective down wave as a simple zigzag [A]-[B]-[C]. The first wave, a
five-wave impulse [A], seems to have completed, and there is unfolding
the bullish correction [B]. Let us study the most recent chart section
in more detail in the eight-hour timeframe.

After the five-wave impulse [A] completed, the market turned up and
started moving up in the ascending correction [B]. The [B] correction
should be unfolding as an upward zigzag (W)-(X)-(Y). The first motive
wave (W) must have completed, and the linking wave (X) is about to end
soon. Therefore, the Bitcoin price should be rising in the second motive
wave (Y) to a level of 42360.00. At this level, wave [B] will reach the
38.2% Fibonacci ratio of the [A] wave.

### Weekly [BTCUSD][1] trading plan:

Buy 33711.50, TP 42360.00
...
If the current price is at $32 904.06, what is the Bitcoin future value?
...
the current Bitcoin price is at $32 904.06. Usually, it’s a better idea
