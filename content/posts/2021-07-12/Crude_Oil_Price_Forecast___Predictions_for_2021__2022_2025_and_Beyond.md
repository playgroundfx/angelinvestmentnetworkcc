...
## Oil weekly price forecast as of 12.07.2021

Within the correction down in the medium-term uptrend, the price reached
the key support 71.09 – 70.25 last week. There started an upward
momentum from the support zone with the target to test the resistance
level 76.03. However, there is no buy pattern in the price chart.

Therefore, it is relevant to look for a buy entry with a target at the
above-indicated level. The second and the primary target of the uptrend
is Target Zone 4, 78.14 – 77.63.

It will be relevant to sell when the price breaks out the support level
of 70.25. If so, the trend will turn down.

### [USCrude][6] Trading ideas for the week:

Buy according to the pattern in the Target Zone 71.09 - 70.25.
TakeProfit: 76.03, Target Zone 4, 78.14 - 77.63. StopLoss: according to
the pattern rules.
