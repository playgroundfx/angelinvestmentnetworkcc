...
## Weekly Elliott wave EOS analysis as of 12.07.2021

There continues forming a large double zigzag. The chart displays the
final section of the first motive wave (W). There is unfolding the first
descending linking wave (X) as a double zigzag W-X-Y. The first two sub-
waves of the pattern look complete. There is developing the final motive
wave Y, it should complete as a double zigzag, like the preceding waves
W and X. Let us explore the initial element of the potential double
zigzag in the H8 timeframe.

The bearish wave (A) completed as a five-wave impulse. Next, the price
has started rising. There could have started the formation of the
corrective wave (B), likely unfolding as a zigzag A-B-C, where the A
wave is a leading diagonal. The entire wave (B) could finish at a level
of around 7.50, where wave (B) will retrace the (A) wave by 38.2%. This
ratio is quite common in zigzags. An approximate trajectory of the EOS
future price movement is outlined in the chart. Therefore, one could
...
( {{count}} {{title}} )
   ...
   5. coinpriceforecast.com/eos
   6. my.liteforex.com/trading/?category=analysts-opinions&slug=eos-price-prediction&type=currency